...
public class CollisionRayTraceStandard {
    ...
    public static MovingObjectPosition collisionRayTrace(
            ICustomCollision b, World world, int x, int y, int z, Vec3 player, Vec3 view) {
        ...
        if (!returns.isEmpty()) {
            ...
            if (min != null) {
                ...
                MovingObjectPosition mop =
                        new MovingObjectPosition(x, y, z, (Byte) min[1], ((Vec3) min[0]).addVector(x, y, z));
                mop.hitInfo = min[3];
                return mop;
            }
        }
    ...
    public static List<Object[]> rayTraceSubBlocks(
            ICustomCollision b, World world, Vec3 player, Vec3 view, int i, int j, int k, List<Object[]> returns) {
