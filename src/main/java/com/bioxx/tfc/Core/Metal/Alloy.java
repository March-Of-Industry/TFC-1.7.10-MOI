    ...
    public Alloy fromPacket(DataInputStream dis) {
        try {
            ...
            for (int i = 0; i < size; i++) {
                AlloyMetal am =
                        new AlloyMetal(MetalRegistry.instance.getMetalFromString(dis.readUTF()), dis.readFloat());
    ...
    public Alloy fromNBT(NBTTagCompound nbt) {
        ...
        for (int i = 0; i < nbtlist.tagCount(); i++) {
            ...
            AlloyMetal am = new AlloyMetal(
                    MetalRegistry.instance.getMetalFromString(nbt1.getString("metalType")), nbt1.getFloat("amount"));
            this.alloyIngred.add(am);
        }
        return this;
    }
