...
public class TFC_ConfigFiles {
    ...
    private static final String[] COLOR_CATEGORIES = {
        COLOR_NUTRIENT_A,
        COLOR_NUTRIENT_B,
        COLOR_NUTRIENT_C,
        CROP_FERTILIZER_COLOR,
        ANVIL_RULE_COLOR0,
        ANVIL_RULE_COLOR1,
        ANVIL_RULE_COLOR2
    };
        ...
        try {
            ...
            new ConversionOption(
                    ...
                    getAsShapeless(
                            ...
                            new ItemStack(Items.emerald)));
            new ConversionOption(
                    "fishConversion", getAsShapeless(new ItemStack(Items.fish, 1), new ItemStack(TFCItems.fishRaw, 1)));
            new ConversionOption(
            ...
            new ConversionOption(
                    ...
                    getAsShapeless(
                            new ItemStack(Items.flint_and_steel, 1, 0), new ItemStack(TFCItems.flintSteel, 1, 0)),
                    getAsShapeless(
                            new ItemStack(TFCItems.flintSteel, 1, 0), new ItemStack(Items.flint_and_steel, 1, 0)));
            new ConversionOption(
                    "leatherArmorConversion",
                    getAsShapeless(
                            new ItemStack(Items.leather_helmet, 1, 0), new ItemStack(TFCItems.leatherHelmet, 1, 0)),
                    getAsShapeless(
                            new ItemStack(TFCItems.leatherHelmet, 1, 0), new ItemStack(Items.leather_helmet, 1, 0)),
                    getAsShapeless(
                    ...
                    getAsShapeless(
                            ...
                            new ItemStack(Items.leather_chestplate, 1, 0)),
                    getAsShapeless(
                            new ItemStack(Items.leather_leggings, 1, 0), new ItemStack(TFCItems.leatherLeggings, 1, 0)),
                    getAsShapeless(
                            new ItemStack(TFCItems.leatherLeggings, 1, 0), new ItemStack(Items.leather_leggings, 1, 0)),
                    getAsShapeless(
                            new ItemStack(Items.leather_boots, 1, 0), new ItemStack(TFCItems.leatherBoots, 1, 0)),
                    getAsShapeless(
                            new ItemStack(TFCItems.leatherBoots, 1, 0), new ItemStack(Items.leather_boots, 1, 0)));
            new ConversionOption(
                    "leatherConversion",
            ...
            new VanillaRecipeOption(
                    "dandelionYellowRecipe", new ItemStack(Items.dye, 1, 11), new ItemStack(Items.dye, 2, 11));
            new VanillaRecipeOption(
                    "diamondArmorRecipe",
            ...
            new VanillaRecipeOption(
                    "stoneSlabsRecipe", new ItemStack(Blocks.stone_slab, 6), new ItemStack(Blocks.stone_slab, 6, 3));
            ...
            new SyncingOption("enableBowlsAlwaysBreak", TFCCrafting.class, craftingConfig, CRAFTING_OPTIONS) {
                private IRecipe recipesTFC = CraftingManagerTFC.getInstance()
                        .addRecipe(new ItemStack(TFCItems.potteryBowl, 2), new Object[] {
                ...
                public String toString() {
                    return name + "[default:" + defaultValue + " current:" + isAplied() + " config:" + inConfig()
                            + " #ofRecipes: 1]";
                }
            };
    ...
    public static void reloadGeneral() {
        ...
        if (craftingConfig.hasCategory("nei hiding"))
            generalConfig
                    .get(GENERAL, "enableNEIHiding", enableNEIHiding)
        ...
        if (yearLength % 12 != 0) {
            ...
            yearLength = 12
                    + (12
                            * (yearLength
                                    / 12)); // Extra validation, because we need multiples of 12. Rounds up so it can
            // never be 0.
            prop.set(yearLength);
        }
    ...
    private static OreSpawnData getOreData(
            String category,
            String type,
            String size,
            String blockName,
