...
public class PlankHighlightHandler {
    ...
    public void drawBlockHighlightEvent(DrawBlockHighlightEvent evt) {
        ...
        if (evt.currentItem != null && evt.currentItem.getItem() instanceof ItemPlank) {
            ...
            boolean isConstruct =
                    world.getBlock(evt.target.blockX, evt.target.blockY, evt.target.blockZ) == TFCBlocks.woodConstruct;
            ...
            GL11.glDepthMask(false);
            // Draw the mini Box
            drawBox(AxisAlignedBB.getBoundingBox(minX, minY, minZ, maxX, maxY, maxZ)
