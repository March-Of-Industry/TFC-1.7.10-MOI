    ...
    public void drawBlockHighlightEvent(DrawBlockHighlightEvent evt) {
        ...
        if (evt.currentItem != null
            ...
            if (b == TFCBlocks.tilledSoil || b == TFCBlocks.tilledSoil2) {
                TEFarmland te = (TEFarmland)
                        world.getTileEntity(evt.target.blockX, evt.target.blockY - crop, evt.target.blockZ);
            ...
            if (b == TFCBlocks.tilledSoil || b == TFCBlocks.tilledSoil2) {
                boolean water = com.bioxx.tfc.Blocks.BlockFarmland.isFreshWaterNearby(
            ...
            if (b == TFCBlocks.crops
                ...
                boolean fullyGrown = index instanceof CropIndexPepper
                        ? te.growth >= index.numGrowthStages - 1
