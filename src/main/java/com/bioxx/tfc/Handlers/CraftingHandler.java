...
public class CraftingHandler {
        ...
        if (iinventory != null) {
            ...
            if (item == TFCItems.stoneBrick) {
                ...
                handleItem(player, iinventory, chisels);
                    ...
                    || item == Item.getItemFromBlock(TFCBlocks.woodSupportH)
     ...
     */
    public static void transferNBT(
            boolean clearContents, EntityPlayer player, ItemStack itemstack, IInventory iinventory) {
        Item item = itemstack.getItem();
        int itemDamage = itemstack.getItemDamage();
    ...
    public static boolean gridHasItem(IInventory iinventory, Item item) {
        for (int i = 0; i < iinventory.getSizeInventory(); i++) {
            if (iinventory.getStackInSlot(i) == null) continue;
            if (iinventory.getStackInSlot(i).getItem() == item) return true;
        }
        return false;
    }
