...
public class EntityLivingHandler {
        ...
        if (event.entityLiving instanceof EntityPlayer) {
            ...
            if (!player.worldObj.isRemote) {
                ...
                TFC_Core.handleItemTicking(
                        player.inventory.mainInventory, player.worldObj, (int) player.posX, (int) player.posY, (int)
                                player.posZ);
                // Handle Food
                ...
                long spawnProtectionTimer = nbt.hasKey("spawnProtectionTimer")
                        ? nbt.getLong("spawnProtectionTimer")
    ...
    public void handleItemPickup(EntityItemPickupEvent event) {
                ...
                if (item.getItem() instanceof ItemArrow) {
                    ...
                    for (int i = 0; i < 9; i++) {
                        if (player.inventory.getStackInSlot(i) != null
                                && player.inventory.getStackInSlot(i).getItem() instanceof ItemJavelin) foundJav = true;
                    }
        ...
        else if (item.getItem().equals(TFCItems.gemDiamond)) player.triggerAchievement(TFC_Achievements.achDiamond);
