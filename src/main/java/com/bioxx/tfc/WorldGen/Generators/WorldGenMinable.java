...
public class WorldGenMinable extends WorldGenerator {
    ...
    public boolean
            generateBeforeCheck() // takes a set of current global variables and checks to see if this ore has spawned
                // before in this chunk
            {
    ...
    public int mPCalculateDensity(int oreDistance, float oreDensity) // returns the density value
        ...
        densityValuePassInner =
                oreDistance / loopCount; // distance devided by number of times it will loop, establishes the number for
        // randomization
