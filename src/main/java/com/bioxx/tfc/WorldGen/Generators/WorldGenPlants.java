...
public class WorldGenPlants implements IWorldGenerator {
    ...
    private static WorldGenCustomFruitTree bananaTree =
            new WorldGenCustomFruitTree(false, TFCBlocks.fruitTreeLeaves, 1);
    private static WorldGenCustomFruitTree orangeTree =
            new WorldGenCustomFruitTree(false, TFCBlocks.fruitTreeLeaves, 2);
    private static WorldGenCustomFruitTree grappleTree =
            new WorldGenCustomFruitTree(false, TFCBlocks.fruitTreeLeaves, 3);
    ...
    private static WorldGenCustomFruitTree cherryTree =
            new WorldGenCustomFruitTree(false, TFCBlocks.fruitTreeLeaves, 6);
        ...
        for (int i = 0; i < grassPerChunk; ++i) {
            ...
            if (world.isAirBlock(xCoord, yCoord, zCoord)
                ...
                world.setBlock(
                        ...
                        zCoord,
                        TFCBlocks.tallGrass,
                        (world.rand.nextInt(20) == 0 ? 1 : 0),
                        0x2); // tallgrass with 1/20 chance to spawn a fern
            }
