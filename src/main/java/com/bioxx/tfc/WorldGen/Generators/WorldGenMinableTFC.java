...
public class WorldGenMinableTFC extends WorldGenerator {
    ...
    public boolean betterOreDistribution(
            int xChunk, int zChunk, Block mPMinableBlock, int mPMinableBlockMeta, int min, int max, Random rand) {
    ...
    public boolean betterOreDistributionVein(
            int xChunk, int zChunk, Block mPMinableBlock, int mPMinableBlockMeta, int min, int max, Random rand) {
        if (rand.nextInt(rarity) == 0) {
            for (int loopCount = 0; loopCount < veinAm; loopCount++) {
                int temp1 = mPCalculateDensity(rand, diameter, hDens);
    ...
    public boolean generate(
            World world, Random random, int x, int z, int min, int max, String n) // absorb default system
            {
    ...
    public int mPCalculateDensity(Random rand, int oreDist, float oreDens) // returns the density value
        ...
        dValPassInr = (int) (oreDist / oreDens
                + .5F); // distance devided by number of times it will loop, establishes the number for randomization
        dValPass = 0;
    ...
    // ======================================================================================
    public int mPCalculateDensityVert(
            Random rand, int oreDist, float oreDens, int min, int max) // returns the density value
            {
        int lpCnt = 0;
        int dValPassInr = 0;
        int dValPass = 0;
