                ...
                for (int var13 = par3 - var10; var13 <= par3 + var10 + 1; ++var13) {
                    ...
                    if ((var12 >= 0 || var14 >= 0 || var12 * var12 + var14 * var14 <= var10 * var10)
                        ...
                        this.setBlockAndNotifyAdequately(
                                par1World, var11, var8, var13, TFCBlocks.leaves, this.leavesMetadata);
                    }
                }
            }
        }
        ...
        if (yCoord >= 1 && yCoord + var6 + 1 <= 256) {
            ...
            if (!canGenHere) {
                ...
                if (TFC_Core.isSoil(world.getBlock(xCoord, yCoord - 1, zCoord)) && yCoord < 256 - var6 - 1) {
                    ...
                    for (int var14 = yCoord + var6 - 2 - rand.nextInt(4);
                            var14 > yCoord + var6 / 2;
                            var14 -= 2 + rand.nextInt(4)) {
                    ...
                    for (tempX = 0; tempX < var6; ++tempX) {
                        ...
                        if (id.isAir(world, xCoord, yCoord + tempX, zCoord)
                                || id == TFCBlocks.leaves
                                || id == TFCBlocks.leaves2) {
                            this.setBlockAndNotifyAdequately(
                                    world, xCoord, yCoord + tempX, zCoord, TFCBlocks.logNatural, this.woodMetadata);
                            if (tempX > 0) {
                                if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord - 1, yCoord + tempX, zCoord))
                                    this.setBlockAndNotifyAdequately(
                                            world, xCoord - 1, yCoord + tempX, zCoord, TFCBlocks.vine, 8);
                                if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord, yCoord + tempX, zCoord - 1))
                                    this.setBlockAndNotifyAdequately(
                                            world, xCoord, yCoord + tempX, zCoord - 1, TFCBlocks.vine, 1);
                            }
                        }
                        ...
                        if (tempX < var6 - 1) {
                            ...
                            if (id.isAir(world, xCoord, yCoord + tempX, zCoord)
                                ...
                                if (tempX > 0) {
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord + 2, yCoord + tempX, zCoord))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord + 2, yCoord + tempX, zCoord, TFCBlocks.vine, 2);
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord + 1, yCoord + tempX, zCoord - 1))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord + 1, yCoord + tempX, zCoord - 1, TFCBlocks.vine, 1);
                                }
                            }
                            ...
                            if (id.isAir(world, xCoord, yCoord + tempX, zCoord)
                                ...
                                if (tempX > 0) {
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord + 2, yCoord + tempX, zCoord + 1))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord + 2, yCoord + tempX, zCoord + 1, TFCBlocks.vine, 2);
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord + 1, yCoord + tempX, zCoord + 2))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord + 1, yCoord + tempX, zCoord + 2, TFCBlocks.vine, 4);
                                }
                            }
                            ...
                            if (id.isAir(world, xCoord, yCoord + tempX, zCoord)
                                ...
                                if (tempX > 0) {
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord - 1, yCoord + tempX, zCoord + 1))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord - 1, yCoord + tempX, zCoord + 1, TFCBlocks.vine, 8);
                                    if (rand.nextInt(3) > 0 && world.isAirBlock(xCoord, yCoord + tempX, zCoord + 2))
                                        this.setBlockAndNotifyAdequately(
                                                world, xCoord, yCoord + tempX, zCoord + 2, TFCBlocks.vine, 4);
                                }
                            }
                        }
                    }
