...
public class MapGenCavesTFC extends MapGenBaseTFC {
    ...
    public void generate(
            IChunkProvider par1IChunkProvider, World par2World, int par3, int par4, Block[] idsBig, byte[] metaBig) {
        // metaArray = metaBig;
    ...
    protected void generateLargeCaveNode(
            long par1, int par3, int par4, Block[] par5, double par6, double par8, double par10) {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D) {
                                            ...
                                            if (TFC_Core.isSoil(idArray[index])
                                                ...
                                                if (TFC_Core.isSoilOrGravel(idArray[index + 1])) {
                                                    for (int upCount = 1;
                                                            TFC_Core.isSoilOrGravel(idArray[index + upCount]);
                                                            upCount++) {
                                                ...
                                                if (var50 < 10
                                                        && TFC_Climate.getStability(
                                                                        this.worldObj, (int) worldX, (int) worldZ)
                                                                == 1) {
