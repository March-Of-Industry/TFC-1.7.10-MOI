...
public class ItemMeal extends ItemTerra implements IFood {
    ...
    public ItemMeal() {
        ...
        this.metaNames = new String[] {
            "Meal0", "Meal1", "Meal2", "Meal3", "Meal4", "Meal5", "Meal6", "Meal7", "Meal8", "Meal9", "Meal10",
        };
    ...
    public ItemStack onEaten(ItemStack is, World world, EntityPlayer player) {
        ...
        if (!world.isRemote) {
            ...
            if (is.hasTagCompound()) {
                ...
                for (int i = 0; i < fg.length; i++) {
                    if (fg[i] != -1)
                        foodstats.addNutrition(
                                FoodRegistry.getInstance().getFoodGroup(fg[i]), eatAmount * nWeights[i] * 2.5f);
                }
