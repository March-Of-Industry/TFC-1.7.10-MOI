...
public class CommandTransferTamed extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] chars) {
        if (sender instanceof EntityPlayer) {
            ...
            List<EntityTameable> entitiesInRange = ((EntityPlayer) sender)
                    .worldObj.getEntitiesWithinAABB(
                            EntityTameable.class, ((EntityPlayer) sender).boundingBox.expand(3, 1, 3));
            ...
            if (entityplayermp == null) {
                ...
                ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation(
                        "commands.transferTamed.display.incoming", new Object[] {sender.func_145748_c_()});
                ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation(
                        "commands.transferTamed.display.outgoing", new Object[] {entityplayermp.func_145748_c_()});
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] string) {
        ...
        return getListOfStringsMatchingLastWord(
                string, MinecraftServer.getServer().getAllUsernames());
    }
