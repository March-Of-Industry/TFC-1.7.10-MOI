        ...
        if (!TFCOptions.enableDebugMode) {
            if (par2ArrayOfStr.length > 1) {
                ...
                if (par2ArrayOfStr[0].equals("set")) {
                    ...
                    if (i < currentTime) {
                        par1ICommandSender.addChatMessage(
                                new ChatComponentText("Cannot set time to before current time."));
                    } else {
                        this.setTime(par1ICommandSender, i);
                        func_152373_a(par1ICommandSender, this, "commands.time.set", new Object[] {Integer.valueOf(i)
                        }); // notifyAdmins
                    }
                    return;
                }
                ...
                if (par2ArrayOfStr[0].equals("add")) {
                    ...
                    if (i + currentTime < currentTime) {
                        ...
                        func_152373_a(
                                par1ICommandSender, this, "commands.time.added", new Object[] {Integer.valueOf(i)});
                    }
                    return;
                }
            }
