...
public class ChunkData {
    ...
    public int protectionBuffer = TFCOptions.protectionBuffer >= 0
            ? TFCOptions.protectionBuffer * -1
            : -24; // Set buffer to default if invalid value in config.
    ...
    private void updateSpawnProtection() {
        ...
        if (lastVisited < now) {
            ...
            lastVisited +=
                    visit * TFC_Time.HOUR_LENGTH; // =now, but taking rounding from integer division above into account
