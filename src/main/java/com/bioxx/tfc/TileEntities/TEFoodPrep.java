...
public class TEFoodPrep extends NetworkTileEntity implements IInventory {
    ...
    private void createSandwich(EntityPlayer player) {
        if (validateSandwich()) // Bread
        {
            ...
            if (getStackInSlot(0) != null)
                foodGroups[0] = ((IFood) (getStackInSlot(0).getItem())).getFoodID();
            if (getStackInSlot(1) != null)
                foodGroups[1] = ((IFood) (getStackInSlot(1).getItem())).getFoodID();
            if (getStackInSlot(2) != null)
                foodGroups[2] = ((IFood) (getStackInSlot(2).getItem())).getFoodID();
            if (getStackInSlot(3) != null)
                foodGroups[3] = ((IFood) (getStackInSlot(3).getItem())).getFoodID();
            if (getStackInSlot(4) != null)
                foodGroups[4] = ((IFood) (getStackInSlot(4).getItem())).getFoodID();
    ...
    private void createSalad(EntityPlayer player) {
        if (validateSalad()) // Bread
        {
            ...
            if (getStackInSlot(1) != null)
                foodGroups[0] = ((IFood) (getStackInSlot(1).getItem())).getFoodID();
            if (getStackInSlot(2) != null)
                foodGroups[1] = ((IFood) (getStackInSlot(2).getItem())).getFoodID();
            if (getStackInSlot(3) != null)
                foodGroups[2] = ((IFood) (getStackInSlot(3).getItem())).getFoodID();
            if (getStackInSlot(4) != null)
                foodGroups[3] = ((IFood) (getStackInSlot(4).getItem())).getFoodID();
