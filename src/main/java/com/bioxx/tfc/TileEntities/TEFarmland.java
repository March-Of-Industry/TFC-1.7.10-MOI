            ...
            if (nutrientTimer < TFC_Time.getTotalHours()) {
                ...
                if (isInfested) {
                    float temp = TFC_Climate.getHeightAdjustedTempSpecificDay(
                            worldObj, TFC_Time.getDayFromTotalHours(this.nutrientTimer), xCoord, yCoord, zCoord);
                ...
                //                        waterSaturation = 30;
                //                }
                //                else if((worldObj.getBlockId(xCoord, yCoord+1, zCoord) == Block.crops.blockID) && crop
                // != null)
                //                {
