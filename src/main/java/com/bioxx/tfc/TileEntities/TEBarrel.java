...
public class TEBarrel extends NetworkTileEntity implements IInventory {
    ...
    public boolean addLiquid(FluidStack inFS) {
        if (inFS != null) {
            ...
            if (inFS.getFluid() != null && inFS.getFluid().getTemperature(inFS) > Global.HOT_LIQUID_TEMP) return false;
    ...
    public void updateEntity() {
        if (!worldObj.isRemote) {
            ...
            BarrelPreservativeRecipe preservative =
                    BarrelManager.getInstance().findMatchingPreservativeRepice(this, itemstack, fluid, sealed);
        ...
        if (this.getInvCount() == 0) {
            ...
            if (getFluidStack() != null && !isCheese) {
                ...
                if (recipe != null && !worldObj.isRemote) {
                    ...
                    FluidStack origFS =
                            getFluidStack() != null ? getFluidStack().copy() : null;
    ...
    public static void registerRecipes() {
        BarrelManager.getInstance()
                .addRecipe(new BarrelAlcoholRecipe(
        ...
        BarrelManager.getInstance()
                .addRecipe(new BarrelMultiItemRecipe(
        ...
        BarrelManager.getInstance()
                .addRecipe(new BarrelRecipe(
                        ...
                        .setMinTechLevel(0));
        BarrelManager.getInstance()
                .addRecipe(new BarrelVinegarRecipe(
        ...
        BarrelManager.getInstance()
                .addRecipe(new BarrelVinegarRecipe(
                        new FluidStack(TFCFluids.CORNWHISKEY, 100), new FluidStack(TFCFluids.VINEGAR, 100)));
        BarrelManager.getInstance()
                .addRecipe(new BarrelLiquidToLiquidRecipe(
                        ...
                        .setRemovesLiquid(false));
        BarrelManager.getInstance()
                .addRecipe(new BarrelBriningRecipe(
        ...
        BarrelPreservativeRecipe picklePreservative = new BarrelPreservativeRecipe(
                        new FluidStack(TFCFluids.VINEGAR, 31), "gui.barrel.preserving")
        ...
        BarrelPreservativeRecipe brineInBrinePreservative = new BarrelPreservativeRecipe(
                        new FluidStack(TFCFluids.BRINE, 62), "gui.barrel.preserving")
                .setAllowGrains(false)
        ...
        BarrelPreservativeRecipe brineInVinegarPreservative = new BarrelPreservativeRecipe(
                        new FluidStack(TFCFluids.VINEGAR, 62), "gui.barrel.preserving")
                .setAllowGrains(false)
                .setRequiresBrined(true)
                .setEnvironmentalDecayFactor(0.75f)
                .setRequiresSealed(true);
