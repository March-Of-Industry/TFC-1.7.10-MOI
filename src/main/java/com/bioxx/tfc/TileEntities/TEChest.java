        ...
        if (!this.adjacentChestChecked) {
            ...
            if (isChest(xCoord - 1, yCoord, zCoord))
                this.adjacentChestXNeg =
                        (TEChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            ...
            if (isChest(xCoord, yCoord, zCoord - 1))
                this.adjacentChestZNeg =
                        (TEChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
