...
public class TEIngotPile extends NetworkTileEntity implements IInventory {
    ...
    public String type;
    public static final Item[] INGOTS = new Item[] {
    ...
    public boolean contentsMatch(int index, ItemStack is) {
        ...
        return storage[index].getItem() == is.getItem()
        ...
        if (storage[index] != null) {
            if (storage[index].stackSize > 0) {
                storage[index] = new ItemStack(
                        storage[index].getItem(), storage[index].stackSize + count, storage[index].getItemDamage());
