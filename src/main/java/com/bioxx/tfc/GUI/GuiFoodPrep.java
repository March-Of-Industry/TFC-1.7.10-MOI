...
public class GuiFoodPrep extends GuiContainerTFC {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_foodprep.png");
    ...
    public void initGui() {
        ...
        if (guiTab == 0) {
            ...
            buttonList.add(new GuiFoodPrepTabButton(
                            2,
                            guiLeft + 36,
                            guiTop - 21,
                            31,
    ...
    public class GuiFoodPrepTabButton extends GuiButton {
        ...
        public GuiFoodPrepTabButton(
                int index, int xPos, int yPos, int width, int height, GuiFoodPrep gui, ItemStack is, String s) {
