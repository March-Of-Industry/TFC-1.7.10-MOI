...
public class GuiLargeVessel extends GuiContainerTFC {
    public static final ResourceLocation TEXTURE =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_largevessel.png");
    ...
    public void createButtons() {
        ...
        if (guiTab == 0) {
            if (!vesselTE.getSealed())
                buttonList.add(
                        new GuiButton(0, guiLeft + 38, guiTop + 50, 50, 20, TFC_Core.translate("gui.Barrel.Seal")));
            else
                buttonList.add(
                        new GuiButton(0, guiLeft + 38, guiTop + 50, 50, 20, TFC_Core.translate("gui.Barrel.Unseal")));
            ...
            if (vesselTE.mode == TEBarrel.MODE_IN)
                buttonList.add(new GuiBarrelTabButton(
                        2,
                        guiLeft + 39,
                        guiTop + 29,
                        16,
            ...
            if (!vesselTE.getSealed())
                buttonList.add(
                        new GuiButton(2, guiLeft + 6, guiTop + 33, 44, 20, TFC_Core.translate("gui.Barrel.Seal")));
            else
                buttonList.add(
                        new GuiButton(2, guiLeft + 6, guiTop + 33, 44, 20, TFC_Core.translate("gui.Barrel.Unseal")));
        }
    }
    ...
    public class GuiButtonMode extends GuiButton {
        ...
        public void drawButton(Minecraft par1Minecraft, int xPos, int yPos) {
            if (this.visible) {
                ...
                this.field_146123_n = xPos >= this.xPosition
                        && yPos >= this.yPosition
    ...
    public class GuiBarrelTabButton extends GuiButton {
        ...
        public GuiBarrelTabButton(
                int index, int xPos, int yPos, int width, int height, GuiLargeVessel gui, IIcon icon, String s) {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int mouseX, int mouseY) {
        ...
        if (guiTab == 0) {
            ...
            if (vesselTE != null && vesselTE.fluid != null) {
                ...
                GL11.glColor4ub((byte) ((color >> 16) & 255), (byte) ((color >> 8) & 255), (byte) (color & 255), (byte)
                        ((0xaa) & 255));
            ...
            if (vesselTE.getFluidStack() != null)
                drawCenteredString(
                        ...
                        vesselTE.fluid.getFluid().getLocalizedName(vesselTE.getFluidStack()),
                        guiLeft + 88,
                        guiTop + 7,
                        0x555555);
            ...
            if (vesselTE.recipe != null) {
                if (!(vesselTE.recipe instanceof BarrelBriningRecipe)) {
                    drawCenteredString(
                            ...
                            guiTop + 72,
                            0x555555);
                } else if (vesselTE.getSealed()
                        && vesselTE.getFluidStack() != null
                        && vesselTE.getFluidStack().getFluid() == TFCFluids.BRINE) {
                    if (inStack != null
                ...
                BarrelPreservativeRecipe preservative = BarrelManager.getInstance()
                        .findMatchingPreservativeRepice(
                                vesselTE, inStack, vesselTE.getFluidStack(), vesselTE.getSealed());
