...
public class GuiAnvil extends GuiContainerTFC {
    ...
    public static ResourceLocation texture =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_anvil.png");
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiAnvilButton(
                7,
                guiLeft + 123,
                guiTop + 82,
                16,
        ...
        buttonList.add(new GuiAnvilPlanButton(
                12, guiLeft + 122, guiTop + 45, 18, 18, this, TFC_Core.translate("gui.Anvil.Plans")));
    }
    ...
    public void drawRulesImages(int w, int h) {
        if (anvilTE.workRecipe != null) {
            ...
            // Bottom Row
            GL11.glColor4ub(
                    TFCOptions.anvilRuleColor0[0], TFCOptions.anvilRuleColor0[1], TFCOptions.anvilRuleColor0[2], (byte)
                            255);
            ...
            // Middle Row
            GL11.glColor4ub(
                    TFCOptions.anvilRuleColor1[0], TFCOptions.anvilRuleColor1[1], TFCOptions.anvilRuleColor1[2], (byte)
                            255);
            ...
            // Top Row
            GL11.glColor4ub(
                    TFCOptions.anvilRuleColor2[0], TFCOptions.anvilRuleColor2[1], TFCOptions.anvilRuleColor2[2], (byte)
                            255);
    ...
    @Override
    protected boolean func_146978_c /*isPointInRegion*/(
            int slotX, int slotY, int sizeX, int sizeY, int clickX, int clickY) {
        int k1 = this.guiLeft;
        int l1 = this.guiTop;
        clickX -= k1;
        clickY -= l1;
    ...
    public void drawTexturedModalRect(
            int drawX, int drawY, int drawWidth, int drawHeight, int u, int v, int width, int height) {
        float f = 0.00390625F;
        ...
        tessellator.addVertexWithUV(
                drawX + drawWidth, drawY + drawHeight, this.zLevel, (u + width) * f, (v + height) * f1);
