...
public class GuiBlueprint extends GuiScreen {
    ...
    protected void keyTyped(char par1, int par2) {
        ...
        ((GuiButton) this.buttonList.get(DONE_BUTTON)).enabled =
                this.nameTextField.getText().trim().length() > 0;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (!stack.hasTagCompound()
                || stack.stackTagCompound.getString(ItemBlueprint.TAG_ITEM_NAME).isEmpty())
            drawCenteredString(
                    fontRendererObj, TFC_Core.translate("gui.Blueprint"), this.width / 2, top + 10, 0x000000);
        ...
        int axesAngleLeft = axesNameLeft
                + fontRendererObj.getStringWidth("X: ")
                + 4
                + 20
