...
public class GuiInventoryTFC extends InventoryEffectRenderer {
    ...
    protected static final ResourceLocation UPPER_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/gui/inventory.png");
    protected static final ResourceLocation UPPER_TEXTURE_2X2 =
            new ResourceLocation(Reference.MOD_ID + ":textures/gui/gui_inventory2x2.png");
    protected static final ResourceLocation EFFECTS_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/gui/inv_effects.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (player.getEntityData().hasKey("craftingTable")) TFC_Core.bindTexture(UPPER_TEXTURE);
    ...
    public static void drawPlayerModel(
            int par0, int par1, int par2, float par3, float par4, EntityLivingBase par5EntityLivingBase) {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiInventoryButton(
                0,
                guiLeft + 176,
                guiTop + 3,
                25,
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 1) Minecraft.getMinecraft().displayGuiScreen(new GuiSkills(player));
        else if (guibutton.id == 2) Minecraft.getMinecraft().displayGuiScreen(new GuiCalendar(player));
        else if (guibutton.id == 3) Minecraft.getMinecraft().displayGuiScreen(new GuiHealth(player));
    }
    ...
    protected boolean isMouseOverSlot(Slot par1Slot, int par2, int par3) {
        return this.func_146978_c /*isPointInRegion*/(
                par1Slot.xDisplayPosition, par1Slot.yDisplayPosition, 16, 16, par2, par3);
    }
    ...
    protected boolean checkHotbarKeys(int keycode) {
        if (this.activeSlot != null
                && this.activeSlot.slotNumber == 0
                && this.activeSlot.getHasStack()
                && this.activeSlot.getStack().getItem() instanceof IFood) return false;
        ...
        if (keycode == 31
                ...
                && activeSlot.getStack().getItem() instanceof IFood
            ...
            for (int i = 9;
                    i < 45
                            && getEmptyCraftSlot() != -1
                            && knifeSlot != -1
                            && inventorySlots.getSlot(knifeSlot).getStack() != null;
                    i++) {
                ItemStack is = this.inventorySlots.getSlot(i).getStack();
                int knifeDamage = inventorySlots.getSlot(knifeSlot).getStack().getItemDamage();
                if (knifeDamage >= inventorySlots.getSlot(knifeSlot).getStack().getMaxDamage()) break;
                if (is != null
    ...
    private int getEmptyCraftSlot() {
        if (this.inventorySlots.getSlot(4).getStack() == null) return 4;
        if (this.inventorySlots.getSlot(1).getStack() == null) return 1;
        if (this.inventorySlots.getSlot(2).getStack() == null) return 2;
        if (this.inventorySlots.getSlot(3).getStack() == null) return 3;
        if (player.getEntityData().hasKey("craftingTable")) {
            if (this.inventorySlots.getSlot(45).getStack() == null) return 45;
            if (this.inventorySlots.getSlot(46).getStack() == null) return 46;
            if (this.inventorySlots.getSlot(47).getStack() == null) return 47;
            if (this.inventorySlots.getSlot(48).getStack() == null) return 48;
            if (this.inventorySlots.getSlot(49).getStack() == null) return 49;
        }
    ...
    private boolean getCraftingHasKnife() {
        if (this.inventorySlots.getSlot(4).getStack() != null
                && this.inventorySlots.getSlot(4).getStack().getItem() instanceof IKnife) return true;
        if (this.inventorySlots.getSlot(1).getStack() != null
                && this.inventorySlots.getSlot(1).getStack().getItem() instanceof IKnife) return true;
        if (this.inventorySlots.getSlot(2).getStack() != null
                && this.inventorySlots.getSlot(2).getStack().getItem() instanceof IKnife) return true;
        if (this.inventorySlots.getSlot(3).getStack() != null
                && this.inventorySlots.getSlot(3).getStack().getItem() instanceof IKnife) return true;
        if (player.getEntityData().hasKey("craftingTable")) {
            if (this.inventorySlots.getSlot(45).getStack() != null
                    && this.inventorySlots.getSlot(45).getStack().getItem() instanceof IKnife) return true;
            if (this.inventorySlots.getSlot(46).getStack() != null
                    && this.inventorySlots.getSlot(46).getStack().getItem() instanceof IKnife) return true;
            if (this.inventorySlots.getSlot(47).getStack() != null
                    && this.inventorySlots.getSlot(47).getStack().getItem() instanceof IKnife) return true;
            if (this.inventorySlots.getSlot(48).getStack() != null
                    && this.inventorySlots.getSlot(48).getStack().getItem() instanceof IKnife) return true;
            if (this.inventorySlots.getSlot(49).getStack() != null
                    && this.inventorySlots.getSlot(49).getStack().getItem() instanceof IKnife) return true;
        }
