...
public class GuiCrucible extends GuiContainerTFC {
    public static ResourceLocation texture =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_crucible.png");
        ...
        if (crucibleTE.currentAlloy != null) {
            if (crucibleTE.currentAlloy.outputAmount == 0) {
                this.fontRendererObj.drawString(
                        EnumChatFormatting.UNDERLINE + TFC_Core.translate("gui.empty"), 7, 7, 0x000000);
                return;
            } else if (crucibleTE.currentAlloy.outputType != null) {
                this.fontRendererObj.drawString(
                        EnumChatFormatting.UNDERLINE
                                + TFC_Core.translate(
                                        "gui.metal." + crucibleTE.currentAlloy.outputType.name.replace(" ", "")),
                        7,
                        7,
                        0x000000);
            } else {
                this.fontRendererObj.drawString(
                        EnumChatFormatting.UNDERLINE + TFC_Core.translate("gui.metal.Unknown"), 7, 7, 0x000000);
            }
                            ...
                            EnumChatFormatting.DARK_GRAY
                                    + TFC_Core.translate("gui.metal."
                                            + crucibleTE
                                                    ...
                                                    .name
                                                    .replace(" ", ""))
                                    + ": " + EnumChatFormatting.DARK_GREEN + m + "%",
                            7,
                            18 + 10 * (c),
                            0x000000);
                }
