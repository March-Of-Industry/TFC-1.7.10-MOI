...
public class GuiSkills extends GuiContainerTFC {
    public static ResourceLocation texture =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_skills.png");
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        for (Skill o : SkillsManager.instance.getSkillsArray()) {
            ...
            if (count < (SKILLS_PER_PAGE * skillsPage) + SKILLS_PER_PAGE && count >= (SKILLS_PER_PAGE * skillsPage)) {
                ...
                fontRendererObj.drawString(
                        TFC_Core.translate(o.skillName) + ": " + EnumChatFormatting.DARK_BLUE
                                + ss.getSkillRank(o.skillName).getLocalizedName(),
                        6,
                        y - 9,
                        0,
                        false);
    ...
    protected void drawGui(ResourceLocation rl) {
        ...
        drawTexturedModalRect(
                guiLeft, guiTop, 0, 0, xSize, ySize); // No inventory drawn, so shifted ySize is not necessary
    }
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 0)
            ...
            if (9 + (skillsPage * SKILLS_PER_PAGE)
                    < SkillsManager.instance.getSkillsArray().size()) skillsPage++;
        }
    }
    ...
    public void updateScreen() {
        ...
        if (9 + (skillsPage * SKILLS_PER_PAGE)
                < SkillsManager.instance.getSkillsArray().size()) ((GuiButton) buttonList.get(5)).enabled = true;
