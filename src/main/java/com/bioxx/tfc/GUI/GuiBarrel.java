...
public class GuiBarrel extends GuiContainerTFC {
    public static final ResourceLocation TEXTURE =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_barrel.png");
    ...
    public class GuiBarrelTabButton extends GuiButton {
        ...
        public GuiBarrelTabButton(
                int index, int xPos, int yPos, int width, int height, GuiBarrel gui, IIcon icon, String s) {
        ...
        if (guiTab == 0) {
            ...
            if (barrelTE.getFluidStack() != null)
                drawCenteredString(
                        ...
                        barrelTE.fluid.getFluid().getLocalizedName(barrelTE.getFluidStack()),
                        guiLeft + 88,
                        guiTop + 7,
                        0x555555);
            ...
            if (barrelTE.recipe != null) {
                if (!(barrelTE.recipe instanceof BarrelBriningRecipe)) {
                    drawCenteredString(
                            ...
                            guiTop + 72,
                            0x555555);
                } else if (barrelTE.getSealed()
                        && barrelTE.getFluidStack() != null
                        && barrelTE.getFluidStack().getFluid() == TFCFluids.BRINE) {
                    if (inStack != null
                ...
                BarrelPreservativeRecipe preservative = BarrelManager.getInstance()
                        .findMatchingPreservativeRepice(
                                barrelTE, inStack, barrelTE.getFluidStack(), barrelTE.getSealed());
