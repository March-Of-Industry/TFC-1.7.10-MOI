...
public class GuiScreenHorseInventoryTFC extends GuiContainerTFC {
    public static ResourceLocation texture =
            new ResourceLocation(Reference.MOD_ID, Reference.ASSET_PATH_GUI + "gui_horse.png");
    ...
    protected void drawForeground(int guiLeft, int guiTop) {
        ...
        GuiInventory.func_147046_a(
                guiLeft + 51, guiTop + 60, 17, guiLeft + 51 - this.xSize, guiTop + 75 - 50 - this.ySize, this.horse);
    }
