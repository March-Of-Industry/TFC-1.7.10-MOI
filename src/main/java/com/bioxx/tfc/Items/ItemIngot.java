...
public class ItemIngot extends ItemTerra implements ISmeltable {
    ...
    public void registerIcons(IIconRegister registerer) {
        this.itemIcon = registerer.registerIcon(Reference.MOD_ID + ":" + textureFolder
    ...
    private boolean createPile(
            ItemStack itemstack, EntityPlayer entityplayer, World world, int x, int y, int z, int side, int l) {
    ...
    public boolean isPlaceable(ItemStack is) {
        ...
        return !(id == TFCItems.weakSteelIngot
                || id == TFCItems.highCarbonSteelIngot
    ...
    public boolean onItemUse(
        ...
        if (entityplayer.isSneaking()
                ...
                && itemstack.getItem().getUnlocalizedName().indexOf("Double") == -1
                ...
                if (te != null) {
                    ...
                    if (te.storage[0] != null && te.contentsMatch(0, itemstack) && te.storage[0].stackSize < 64) {
                        ...
                        te.validate();
                            ...
                            && !te.contentsMatch(0, itemstack)
                            && te.storage[0].stackSize < 64) {
                        return false;
                    } else if (te.storage[0] == null) {
    ...
    public int getItemStackLimit(ItemStack is) {
        ...
        if (is.hasTagCompound()) {
            ...
            if (TFC_ItemHeat.hasTemp(is)
                    || tag.hasKey(TEAnvil.ITEM_CRAFTING_VALUE_TAG)
