    ...
    public boolean onItemUse(
        ...
        if (!world.isRemote) {
            if (entityplayer.isSneaking() && (world.getBlock(x, y, z) != TFCBlocks.logPile || side != 1 && side != 0)) {
                ...
                if (side == 0
                        && block.canPlaceBlockAt(world, x, y - 1, z)
                    ...
                    playSound(world, x, y, z);
                        ...
                        && block.canPlaceBlockAt(world, x, y, z - 1)
                    ...
                    setSide(world, itemstack, m, side, x, y, z + 1);
                        ...
                        && block.canPlaceBlockAt(world, x - 1, y, z)
                        && world.canPlaceEntityOnSide(TFCBlocks.woodVert, x - 1, y, z, false, side, null, itemstack)) {
