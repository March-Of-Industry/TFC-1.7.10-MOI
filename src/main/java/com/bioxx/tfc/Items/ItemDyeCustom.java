...
public class ItemDyeCustom extends ItemTerra {
    ...
    public static final String[] DYE_COLOR_NAMES = new String[] {
        "black",
        "red",
        "green",
        "brown",
    ...
    public static final int[] DYE_COLORS = new int[] {
        1973019, 11743532, 3887386, 5320730, 2437522, 8073150, 2651799, 2651799, 4408131, 14188952, 4312372, 14602026,
