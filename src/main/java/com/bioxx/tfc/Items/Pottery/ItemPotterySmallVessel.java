...
public class ItemPotterySmallVessel extends ItemPotteryBase implements IBag {
    ...
    public IIcon getIcon(ItemStack stack, int pass) {
        if (pass == 1
                ...
                && stack.getTagCompound().hasKey("color")) return overlayIcon;
    ...
    public int getColor(ItemStack is) {
        if (!is.hasTagCompound() || !is.getTagCompound().hasKey("color")) return -1;
                    ...
                    if (byte0 >= 0 && byte0 < 4) {
                        ...
                        if (itemstack.stackSize > 0) {
                            if (itemstack.getItem() instanceof ItemFoodTFC) {
                                ...
                                arraylist.add(EnumChatFormatting.GOLD.toString()
                                        + itemstack.getItem().getItemStackDisplayName(itemstack) + " "
                                        + EnumChatFormatting.WHITE + weight + "oz" + ds);
                            } else
                                arraylist.add(EnumChatFormatting.GOLD.toString() + itemstack.stackSize + "x "
                                        + itemstack.getItem().getItemStackDisplayName(itemstack));
                        }
                    }
                }
