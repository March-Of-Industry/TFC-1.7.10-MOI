...
public class ItemWoodSupport extends ItemTerraBlock {
    ...
    public boolean isValidUnder(World world, int x, int y, int z, int side) {
        ...
        return b == TFCBlocks.woodSupportV
                || b == TFCBlocks.woodSupportV2
            ...
            if (y == 255 && b.getMaterial().isSolid()) {
                ...
                while (true) {
                    int j1 = b.onBlockPlaced(
                            world, x + (dir.offsetX * count), y, z + (dir.offsetZ * count), side, hitX, hitY, hitZ, i1);
                    if (placeBlockAt(
                            b,
                            itemstack,
                            player,
    ...
    public boolean placeBlockAt(
            Block b, ItemStack is, EntityPlayer player, World world, int x, int y, int z, int metadata, int flag) {
