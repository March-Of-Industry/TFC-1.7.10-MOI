...
public class ItemWoodDoor extends ItemTerra {
    ...
    public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block) {
        ...
        int var8 = (par0World.getBlock(par1 - var6, par2, par3 - var7).isNormalCube() ? 1 : 0)
                + (par0World.getBlock(par1 - var6, par2 + 1, par3 - var7).isNormalCube() ? 1 : 0);
        int var9 = (par0World.getBlock(par1 + var6, par2, par3 + var7).isNormalCube() ? 1 : 0)
                + (par0World.getBlock(par1 + var6, par2 + 1, par3 + var7).isNormalCube() ? 1 : 0);
