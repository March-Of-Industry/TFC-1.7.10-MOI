...
public class TF_EntityRenderer extends ClassTransformer {
    ...
    public TF_EntityRenderer() {
        ...
        list.add(new FieldInsnNode(
                Opcodes.GETFIELD, "net/minecraft/client/renderer/EntityRenderer", "random", "Ljava/util/Random;"));
        list.add(new VarInsnNode(Opcodes.ALOAD, 0));
        list.add(new FieldInsnNode(
                Opcodes.GETFIELD, "net/minecraft/client/renderer/EntityRenderer", "rendererUpdateCount", "I"));
        list.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC, "com/bioxx/tfc/ClientOverrides", "doRainClient", "(Ljava/util/Random;I)V"));
