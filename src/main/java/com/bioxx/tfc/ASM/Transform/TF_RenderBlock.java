...
public class TF_RenderBlock extends ClassTransformer {
    ...
    public TF_RenderBlock() {
        ...
        this.mcpMethodNodes.put(
                "renderFaceZNeg | (Lnet/minecraft/block/Block;DDDLnet/minecraft/util/IIcon;)V", new Patch(nodes));
        ...
        this.mcpMethodNodes.put(
                "renderFaceXPos | (Lnet/minecraft/block/Block;DDDLnet/minecraft/util/IIcon;)V", new Patch(nodes));
