...
public class ItemSetup extends TFCItems {
    ...
    public static void setup() {
        ...
        bismuthBronzeToolMaterial =
                EnumHelper.addToolMaterial("BismuthBronze", 2, bismuthBronzeUses, bismuthBronzeEff, 90, 10);
        ...
        minecartCrate =
                new ItemCustomMinecart(1).setUnlocalizedName("minecartChest").setTextureName("minecart_chest");
        goldPan = new ItemGoldPan().setUnlocalizedName("GoldPan");
        sluiceItem = new ItemSluice()
                .setFolder("devices/")
                .setUnlocalizedName("SluiceItem")
                .setCreativeTab(TFCTabs.TFC_DEVICES);

        shears =
                new ItemShears(0, ironToolMaterial).setUnlocalizedName("shears").setTextureName("shears");

        proPickBismuthBronze =
                new ItemProPick().setUnlocalizedName("Bismuth Bronze ProPick").setMaxDamage(bismuthBronzeUses / 3);
        proPickBlackBronze =
                new ItemProPick().setUnlocalizedName("Black Bronze ProPick").setMaxDamage(blackBronzeUses / 3);
        proPickBlackSteel =
                new ItemProPick().setUnlocalizedName("Black Steel ProPick").setMaxDamage(blackSteelUses / 3);
        proPickBlueSteel =
                new ItemProPick().setUnlocalizedName("Blue Steel ProPick").setMaxDamage(blueSteelUses / 3);
        ...
        proPickIron =
                new ItemProPick().setUnlocalizedName("Wrought Iron ProPick").setMaxDamage(wroughtIronUses / 3);
        proPickRedSteel =
                new ItemProPick().setUnlocalizedName("Red Steel ProPick").setMaxDamage(redSteelUses / 3);
        ...
        brassIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Brass Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Brass", 200);
        bronzeIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Bronze Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Bronze", 200);
        copperIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Copper Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Copper", 200);
        goldIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Gold Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Gold", 200);
        wroughtIronIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Wrought Iron Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Wrought Iron", 200);
        leadIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Lead Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Lead", 200);
        nickelIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Nickel Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Nickel", 200);
        ...
        silverIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Silver Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Silver", 200);
        steelIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Steel Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Steel", 200);
        ...
        tinIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Tin Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Tin", 200);
        zincIngot2x = ((ItemIngot) new ItemIngot().setUnlocalizedName("Zinc Double Ingot"))
                .setSize(EnumSize.LARGE)
                .setMetal("Zinc", 200);
        ...
        // Tools
        igInShovel = new ItemCustomShovel(igInToolMaterial)
                .setUnlocalizedName("IgIn Stone Shovel")
                .setMaxDamage(igInStoneUses);
        igInAxe = new ItemCustomAxe(igInToolMaterial, 60)
                .setUnlocalizedName("IgIn Stone Axe")
                .setMaxDamage(igInStoneUses);
        igInHoe = new ItemCustomHoe(igInToolMaterial)
                .setUnlocalizedName("IgIn Stone Hoe")
                .setMaxDamage(igInStoneUses);

        sedShovel = new ItemCustomShovel(sedToolMaterial)
                .setUnlocalizedName("Sed Stone Shovel")
                .setMaxDamage(sedStoneUses);
        sedAxe = new ItemCustomAxe(sedToolMaterial, 60)
                .setUnlocalizedName("Sed Stone Axe")
                .setMaxDamage(sedStoneUses);
        sedHoe = new ItemCustomHoe(sedToolMaterial)
                .setUnlocalizedName("Sed Stone Hoe")
                .setMaxDamage(sedStoneUses);

        igExShovel = new ItemCustomShovel(igExToolMaterial)
                .setUnlocalizedName("IgEx Stone Shovel")
                .setMaxDamage(igExStoneUses);
        igExAxe = new ItemCustomAxe(igExToolMaterial, 60)
                .setUnlocalizedName("IgEx Stone Axe")
                .setMaxDamage(igExStoneUses);
        igExHoe = new ItemCustomHoe(igExToolMaterial)
                .setUnlocalizedName("IgEx Stone Hoe")
                .setMaxDamage(igExStoneUses);

        mMShovel = new ItemCustomShovel(mMToolMaterial)
                .setUnlocalizedName("MM Stone Shovel")
                .setMaxDamage(mMStoneUses);
        mMAxe = new ItemCustomAxe(mMToolMaterial, 60)
                .setUnlocalizedName("MM Stone Axe")
                .setMaxDamage(mMStoneUses);
        mMHoe = new ItemCustomHoe(mMToolMaterial)
                .setUnlocalizedName("MM Stone Hoe")
                .setMaxDamage(mMStoneUses);

        bismuthBronzePick = new ItemCustomPickaxe(bismuthBronzeToolMaterial)
                .setUnlocalizedName("Bismuth Bronze Pick")
        ...
        bismuthBronzeShovel = new ItemCustomShovel(bismuthBronzeToolMaterial)
                ...
                .setMaxDamage(bismuthBronzeUses);
        bismuthBronzeAxe = new ItemCustomAxe(bismuthBronzeToolMaterial, 150)
                .setUnlocalizedName("Bismuth Bronze Axe")
                .setMaxDamage(bismuthBronzeUses);
        bismuthBronzeHoe = new ItemCustomHoe(bismuthBronzeToolMaterial)
                .setUnlocalizedName("Bismuth Bronze Hoe")
                .setMaxDamage(bismuthBronzeUses);

        blackBronzePick = new ItemCustomPickaxe(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Pick")
                .setMaxDamage(blackBronzeUses);
        blackBronzeShovel = new ItemCustomShovel(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Shovel")
                .setMaxDamage(blackBronzeUses);
        blackBronzeAxe = new ItemCustomAxe(blackBronzeToolMaterial, 170)
                .setUnlocalizedName("Black Bronze Axe")
                .setMaxDamage(blackBronzeUses);
        blackBronzeHoe = new ItemCustomHoe(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Hoe")
                .setMaxDamage(blackBronzeUses);

        blackSteelPick = new ItemCustomPickaxe(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Pick")
                .setMaxDamage(blackSteelUses);
        blackSteelShovel = new ItemCustomShovel(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Shovel")
                .setMaxDamage(blackSteelUses);
        blackSteelAxe = new ItemCustomAxe(blackSteelToolMaterial, 245)
                .setUnlocalizedName("Black Steel Axe")
                .setMaxDamage(blackSteelUses);
        blackSteelHoe = new ItemCustomHoe(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Hoe")
                .setMaxDamage(blackSteelUses);

        blueSteelPick = new ItemCustomPickaxe(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Pick")
                .setMaxDamage(blueSteelUses);
        blueSteelShovel = new ItemCustomShovel(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Shovel")
                .setMaxDamage(blueSteelUses);
        blueSteelAxe = new ItemCustomAxe(blueSteelToolMaterial, 270)
                .setUnlocalizedName("Blue Steel Axe")
                .setMaxDamage(blueSteelUses);
        blueSteelHoe = new ItemCustomHoe(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Hoe")
                .setMaxDamage(blueSteelUses);

        bronzePick = new ItemCustomPickaxe(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Pick")
                .setMaxDamage(bronzeUses);
        bronzeShovel = new ItemCustomShovel(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Shovel")
                .setMaxDamage(bronzeUses);
        bronzeAxe = new ItemCustomAxe(bronzeToolMaterial, 160)
                .setUnlocalizedName("Bronze Axe")
                .setMaxDamage(bronzeUses);
        bronzeHoe = new ItemCustomHoe(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Hoe")
                .setMaxDamage(bronzeUses);

        copperPick = new ItemCustomPickaxe(copperToolMaterial)
                .setUnlocalizedName("Copper Pick")
                .setMaxDamage(copperUses);
        copperShovel = new ItemCustomShovel(copperToolMaterial)
                .setUnlocalizedName("Copper Shovel")
                .setMaxDamage(copperUses);
        copperAxe = new ItemCustomAxe(copperToolMaterial, 115)
                .setUnlocalizedName("Copper Axe")
                .setMaxDamage(copperUses);
        copperHoe = new ItemCustomHoe(copperToolMaterial)
                .setUnlocalizedName("Copper Hoe")
                .setMaxDamage(copperUses);

        wroughtIronPick = new ItemCustomPickaxe(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Pick")
                .setMaxDamage(wroughtIronUses);
        wroughtIronShovel = new ItemCustomShovel(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Shovel")
                .setMaxDamage(wroughtIronUses);
        wroughtIronAxe = new ItemCustomAxe(ironToolMaterial, 185)
                .setUnlocalizedName("Wrought Iron Axe")
                .setMaxDamage(wroughtIronUses);
        wroughtIronHoe = new ItemCustomHoe(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Hoe")
                .setMaxDamage(wroughtIronUses);

        redSteelPick = new ItemCustomPickaxe(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Pick")
                .setMaxDamage(redSteelUses);
        redSteelShovel = new ItemCustomShovel(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Shovel")
                .setMaxDamage(redSteelUses);
        redSteelAxe = new ItemCustomAxe(redSteelToolMaterial, 270)
                .setUnlocalizedName("Red Steel Axe")
                .setMaxDamage(redSteelUses);
        redSteelHoe = new ItemCustomHoe(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Hoe")
                .setMaxDamage(redSteelUses);

        steelPick = new ItemCustomPickaxe(steelToolMaterial)
                .setUnlocalizedName("Steel Pick")
                .setMaxDamage(steelUses);
        steelShovel = new ItemCustomShovel(steelToolMaterial)
                .setUnlocalizedName("Steel Shovel")
                .setMaxDamage(steelUses);
        steelAxe = new ItemCustomAxe(steelToolMaterial, 210)
                .setUnlocalizedName("Steel Axe")
                .setMaxDamage(steelUses);
        steelHoe = new ItemCustomHoe(steelToolMaterial)
                .setUnlocalizedName("Steel Hoe")
                .setMaxDamage(steelUses);

        // chisels
        bismuthBronzeChisel = new ItemChisel(bismuthBronzeToolMaterial)
                .setUnlocalizedName("Bismuth Bronze Chisel")
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeChisel = new ItemChisel(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Chisel")
                .setMaxDamage(blackBronzeUses);
        blackSteelChisel = new ItemChisel(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Chisel")
                .setMaxDamage(blackSteelUses);
        blueSteelChisel = new ItemChisel(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Chisel")
                .setMaxDamage(blueSteelUses);
        bronzeChisel = new ItemChisel(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Chisel")
                .setMaxDamage(bronzeUses);
        copperChisel = new ItemChisel(copperToolMaterial)
                .setUnlocalizedName("Copper Chisel")
                .setMaxDamage(copperUses);
        wroughtIronChisel = new ItemChisel(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Chisel")
                .setMaxDamage(wroughtIronUses);
        redSteelChisel = new ItemChisel(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Chisel")
                .setMaxDamage(redSteelUses);
        steelChisel = new ItemChisel(steelToolMaterial)
                .setUnlocalizedName("Steel Chisel")
                .setMaxDamage(steelUses);

        bismuthBronzeSword = new ItemCustomSword(bismuthBronzeToolMaterial, 210)
                .setUnlocalizedName("Bismuth Bronze Sword")
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeSword = new ItemCustomSword(blackBronzeToolMaterial, 230)
                .setUnlocalizedName("Black Bronze Sword")
                .setMaxDamage(blackBronzeUses);
        blackSteelSword = new ItemCustomSword(blackSteelToolMaterial, 270)
                .setUnlocalizedName("Black Steel Sword")
                .setMaxDamage(blackSteelUses);
        blueSteelSword = new ItemCustomSword(blueSteelToolMaterial, 315)
                .setUnlocalizedName("Blue Steel Sword")
                .setMaxDamage(blueSteelUses);
        bronzeSword = new ItemCustomSword(bronzeToolMaterial, 220)
                .setUnlocalizedName("Bronze Sword")
                .setMaxDamage(bronzeUses);
        copperSword = new ItemCustomSword(copperToolMaterial, 165)
                .setUnlocalizedName("Copper Sword")
                .setMaxDamage(copperUses);
        wroughtIronSword = new ItemCustomSword(ironToolMaterial, 240)
                .setUnlocalizedName("Wrought Iron Sword")
                .setMaxDamage(wroughtIronUses);
        redSteelSword = new ItemCustomSword(redSteelToolMaterial, 315)
                .setUnlocalizedName("Red Steel Sword")
                .setMaxDamage(redSteelUses);
        steelSword = new ItemCustomSword(steelToolMaterial, 265)
                .setUnlocalizedName("Steel Sword")
                .setMaxDamage(steelUses);
        ...
        bismuthBronzeSaw = new ItemCustomSaw(bismuthBronzeToolMaterial)
                .setUnlocalizedName("Bismuth Bronze Saw")
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeSaw = new ItemCustomSaw(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Saw")
                .setMaxDamage(blackBronzeUses);
        blackSteelSaw = new ItemCustomSaw(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Saw")
                .setMaxDamage(blackSteelUses);
        blueSteelSaw = new ItemCustomSaw(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Saw")
                .setMaxDamage(blueSteelUses);
        bronzeSaw = new ItemCustomSaw(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Saw")
                .setMaxDamage(bronzeUses);
        copperSaw = new ItemCustomSaw(copperToolMaterial)
                .setUnlocalizedName("Copper Saw")
                .setMaxDamage(copperUses);
        wroughtIronSaw = new ItemCustomSaw(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Saw")
                .setMaxDamage(wroughtIronUses);
        redSteelSaw = new ItemCustomSaw(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Saw")
                .setMaxDamage(redSteelUses);
        steelSaw = new ItemCustomSaw(steelToolMaterial)
                .setUnlocalizedName("Steel Saw")
                .setMaxDamage(steelUses);
        ...
        powder = new ItemTerra()
                .setMetaNames(Global.POWDER)
        ...
        bismuthBronzeJavelin =
                new ItemJavelin(bismuthBronzeToolMaterial, 90).setUnlocalizedName("Bismuth Bronze Javelin");
        ...
        // Hammers
        stoneHammer = new ItemHammer(igInToolMaterial, 60)
                .setUnlocalizedName("Stone Hammer")
                .setMaxDamage(igInStoneUses);
        bismuthBronzeHammer = new ItemHammer(bismuthBronzeToolMaterial, 90)
                .setUnlocalizedName("Bismuth Bronze Hammer")
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeHammer = new ItemHammer(blackBronzeToolMaterial, 95)
                .setUnlocalizedName("Black Bronze Hammer")
                .setMaxDamage(blackBronzeUses);
        blackSteelHammer = new ItemHammer(blackSteelToolMaterial, 205)
                .setUnlocalizedName("Black Steel Hammer")
                .setMaxDamage(blackSteelUses);
        blueSteelHammer = new ItemHammer(blueSteelToolMaterial, 240)
                .setUnlocalizedName("Blue Steel Hammer")
                .setMaxDamage(blueSteelUses);
        bronzeHammer = new ItemHammer(bronzeToolMaterial, 100)
                .setUnlocalizedName("Bronze Hammer")
                .setMaxDamage(bronzeUses);
        copperHammer = new ItemHammer(copperToolMaterial, 80)
                .setUnlocalizedName("Copper Hammer")
                .setMaxDamage(copperUses);
        wroughtIronHammer = new ItemHammer(ironToolMaterial, 135)
                .setUnlocalizedName("Wrought Iron Hammer")
                .setMaxDamage(wroughtIronUses);
        redSteelHammer = new ItemHammer(redSteelToolMaterial, 240)
                .setUnlocalizedName("Red Steel Hammer")
                .setMaxDamage(redSteelUses);
        steelHammer = new ItemHammer(steelToolMaterial, 170)
                .setUnlocalizedName("Steel Hammer")
                .setMaxDamage(steelUses);
        ...
        bismuthBronzeScythe = new ItemCustomScythe(bismuthBronzeToolMaterial)
                ...
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeScythe = new ItemCustomScythe(blackBronzeToolMaterial)
                .setUnlocalizedName("Black Bronze Scythe")
                .setMaxDamage(blackBronzeUses);
        blackSteelScythe = new ItemCustomScythe(blackSteelToolMaterial)
                .setUnlocalizedName("Black Steel Scythe")
                .setMaxDamage(blackSteelUses);
        blueSteelScythe = new ItemCustomScythe(blueSteelToolMaterial)
                .setUnlocalizedName("Blue Steel Scythe")
                .setMaxDamage(blueSteelUses);
        bronzeScythe = new ItemCustomScythe(bronzeToolMaterial)
                .setUnlocalizedName("Bronze Scythe")
                .setMaxDamage(bronzeUses);
        copperScythe = new ItemCustomScythe(copperToolMaterial)
                .setUnlocalizedName("Copper Scythe")
                .setMaxDamage(copperUses);
        wroughtIronScythe = new ItemCustomScythe(ironToolMaterial)
                .setUnlocalizedName("Wrought Iron Scythe")
                .setMaxDamage(wroughtIronUses);
        redSteelScythe = new ItemCustomScythe(redSteelToolMaterial)
                .setUnlocalizedName("Red Steel Scythe")
                .setMaxDamage(redSteelUses);
        steelScythe = new ItemCustomScythe(steelToolMaterial)
                .setUnlocalizedName("Steel Scythe")
                .setMaxDamage(steelUses);
        ...
        woodenBucketWater =
                new ItemCustomBucket(TFCBlocks.freshWater, woodenBucketEmpty).setUnlocalizedName("Wooden Bucket Water");
        ...
        woodenBucketMilk = new ItemCustomBucketMilk()
                .setUnlocalizedName("Wooden Bucket Milk")
        ...
        bismuthBronzeKnife = new ItemKnife(bismuthBronzeToolMaterial, 155)
                .setUnlocalizedName("Bismuth Bronze Knife")
                .setMaxDamage(bismuthBronzeUses);
        blackBronzeKnife = new ItemKnife(blackBronzeToolMaterial, 165)
                .setUnlocalizedName("Black Bronze Knife")
                .setMaxDamage(blackBronzeUses);
        blackSteelKnife = new ItemKnife(blackSteelToolMaterial, 205)
                .setUnlocalizedName("Black Steel Knife")
                .setMaxDamage(blackSteelUses);
        blueSteelKnife = new ItemKnife(blueSteelToolMaterial, 250)
                .setUnlocalizedName("Blue Steel Knife")
                .setMaxDamage(blueSteelUses);
        bronzeKnife = new ItemKnife(bronzeToolMaterial, 150)
                .setUnlocalizedName("Bronze Knife")
                .setMaxDamage(bronzeUses);
        copperKnife = new ItemKnife(copperToolMaterial, 100)
                .setUnlocalizedName("Copper Knife")
                .setMaxDamage(copperUses);
        wroughtIronKnife = new ItemKnife(ironToolMaterial, 175)
                .setUnlocalizedName("Wrought Iron Knife")
                .setMaxDamage(wroughtIronUses);
        redSteelKnife = new ItemKnife(redSteelToolMaterial, 250)
                .setUnlocalizedName("Red Steel Knife")
                .setMaxDamage(redSteelUses);
        steelKnife = new ItemKnife(steelToolMaterial, 200)
                .setUnlocalizedName("Steel Knife")
                .setMaxDamage(steelUses);

        flatRock = new ItemFlatGeneric()
                .setFolder("rocks/flatrocks/")
                .setMetaNames(Global.STONE_ALL)
                .setUnlocalizedName("FlatRock");
        looseRock = new ItemLooseRock()
                .setSpecialCraftingType(flatRock)
                .setFolder("rocks/")
                .setMetaNames(Global.STONE_ALL)
        ...
        stoneKnife = new ItemKnife(igExToolMaterial, 40)
                .setUnlocalizedName("Stone Knife")
                .setMaxDamage(igExStoneUses);
        ...
        redSteelBucketWater = new ItemSteelBucketRed(TFCBlocks.freshWater)
                .setUnlocalizedName("Red Steel Bucket Water")
        ...
        blueSteelBucketLava = new ItemSteelBucketBlue(TFCBlocks.lava)
                .setUnlocalizedName("Blue Steel Bucket Lava")
                .setContainerItem(blueSteelBucketEmpty);

        quern = ((ItemTerra) new ItemTerra().setUnlocalizedName("Quern").setMaxDamage(250))
                .setSize(EnumSize.MEDIUM)
                .setWeight(EnumWeight.HEAVY);
        flintSteel = new ItemFlintSteel()
        ...
        spindleHead = new ItemPotteryBase()
                .setMetaNames(new String[] {"Clay Spindle", "Spindle Head"})
        ...
        mortar =
                new ItemTerra().setFolder("tools/").setUnlocalizedName("Mortar").setCreativeTab(TFCTabs.TFC_MATERIALS);
        vinegar = new ItemCustomBucket(Blocks.air)
                .setFolder("food/")
        ...
        soakedHide = new ItemRawHide()
                .setFolder("tools/")
                .setUnlocalizedName("Soaked Hide")
                .setCreativeTab(TFCTabs.TFC_MATERIALS);
        scrapedHide = new ItemRawHide()
                .setFolder("tools/")
                .setUnlocalizedName("Scraped Hide")
                .setCreativeTab(TFCTabs.TFC_MATERIALS);
        prepHide = new ItemRawHide()
                .setFolder("tools/")
                .setFolder("tools/")
                .setUnlocalizedName("Prep Hide")
                .setCreativeTab(TFCTabs.TFC_MATERIALS);

        sheepSkin = new ItemRawHide()
                .setFolder("tools/")
        ...
        leather = new ItemLeather()
                .setSpecialCraftingType(flatLeather)
                .setFolder("tools/")
        ...
        flatClay = new ItemFlatGeneric()
                .setFolder("pottery/")
                .setMetaNames(
                        new String[] {"clay flat light", "clay flat dark", "clay flat fire", "clay flat dark fire"})
        ...
        ceramicMold = new ItemPotteryBase()
                .setMetaNames(new String[] {"Clay Mold", "Ceramic Mold"})
                .setUnlocalizedName("Mold");
        potteryBowl = new ItemPotteryBase()
                .setMetaNames(new String[] {"Clay Bowl", "Ceramic Bowl"})
                .setUnlocalizedName("ClayBowl");
        clayBall = new ItemClay()
                .setSpecialCraftingType(flatClay, new ItemStack(flatClay, 1, 1))
                .setMetaNames(new String[] {"Clay", "Fire Clay"})
                .setUnlocalizedName("Clay");
        fireBrick = new ItemPotteryBase()
                .setMetaNames(new String[] {"Clay Fire Brick", "Fire Brick"})
                .setUnlocalizedName("Fire Brick");

        clayMoldAxe = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Axe",
                    "Ceramic Mold Axe",
                    "Ceramic Mold Axe Copper",
                    "Ceramic Mold Axe Bronze",
                    "Ceramic Mold Axe Bismuth Bronze",
                    "Ceramic Mold Axe Black Bronze"
                })
        ...
        clayMoldChisel = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    ...
                    "Ceramic Mold Chisel Bronze",
                    "Ceramic Mold Chisel Bismuth Bronze",
        ...
        clayMoldHammer = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    ...
                    "Ceramic Mold Hammer Bronze",
                    "Ceramic Mold Hammer Bismuth Bronze",
        ...
        clayMoldHoe = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Hoe",
                    "Ceramic Mold Hoe",
                    "Ceramic Mold Hoe Copper",
                    "Ceramic Mold Hoe Bronze",
                    "Ceramic Mold Hoe Bismuth Bronze",
                    "Ceramic Mold Hoe Black Bronze"
                })
                .setUnlocalizedName("Hoe Mold");
        clayMoldKnife = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Knife",
                    "Ceramic Mold Knife",
                    "Ceramic Mold Knife Copper",
                    "Ceramic Mold Knife Bronze",
                    "Ceramic Mold Knife Bismuth Bronze",
                    "Ceramic Mold Knife Black Bronze"
                })
        ...
        clayMoldMace = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    ...
                    "Ceramic Mold Mace Bronze",
                    "Ceramic Mold Mace Bismuth Bronze",
                    "Ceramic Mold Mace Black Bronze"
                })
        ...
        clayMoldPick = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    ...
                    "Ceramic Mold Pick Bronze",
                    "Ceramic Mold Pick Bismuth Bronze",
                    "Ceramic Mold Pick Black Bronze"
                })
        ...
        clayMoldProPick = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    ...
                    "Ceramic Mold ProPick Bronze",
                    "Ceramic Mold ProPick Bismuth Bronze",
        ...
        clayMoldSaw = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Saw",
                    "Ceramic Mold Saw",
                    "Ceramic Mold Saw Copper",
                    "Ceramic Mold Saw Bronze",
                    "Ceramic Mold Saw Bismuth Bronze",
                    "Ceramic Mold Saw Black Bronze"
                })
        ...
        clayMoldScythe = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Scythe",
                    "Ceramic Mold Scythe",
                    "Ceramic Mold Scythe Copper",
                    "Ceramic Mold Scythe Bronze",
                    "Ceramic Mold Scythe Bismuth Bronze",
        ...
        clayMoldShovel = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Shovel",
                    "Ceramic Mold Shovel",
                    "Ceramic Mold Shovel Copper",
                    "Ceramic Mold Shovel Bronze",
                    "Ceramic Mold Shovel Bismuth Bronze",
                    "Ceramic Mold Shovel Black Bronze"
                })
                .setUnlocalizedName("Shovel Mold");
        clayMoldSword = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Sword",
                    "Ceramic Mold Sword",
                    "Ceramic Mold Sword Copper",
                    "Ceramic Mold Sword Bronze",
                    "Ceramic Mold Sword Bismuth Bronze",
                    "Ceramic Mold Sword Black Bronze"
                })
                .setUnlocalizedName("Sword Mold");
        clayMoldJavelin = new ItemPotteryMold()
                .setMetaNames(new String[] {
                    "Clay Mold Javelin",
                    "Ceramic Mold Javelin",
                    "Ceramic Mold Javelin Copper",
                    "Ceramic Mold Javelin Bronze",
                    "Ceramic Mold Javelin Bismuth Bronze",
        ...
        Recipes.meltedMetal = new Item[] {
            bismuthUnshaped,
            bismuthBronzeUnshaped,
            blackBronzeUnshaped,
            blackSteelUnshaped,
            blueSteelUnshaped,
            brassUnshaped,
            ...
            silverUnshaped,
            steelUnshaped,
            sterlingSilverUnshaped,
            tinUnshaped,
            zincUnshaped,
            highCarbonSteelUnshaped,
            weakSteelUnshaped,
            highCarbonBlackSteelUnshaped,
            highCarbonBlueSteelUnshaped,
            highCarbonRedSteelUnshaped,
            weakBlueSteelUnshaped,
            weakRedSteelUnshaped
        };

        Recipes.hammers = new Item[] {
            stoneHammer,
            bismuthBronzeHammer,
            blackBronzeHammer,
            blackSteelHammer,
        ...
        TerraFirmaCraft.LOG.info(
                new StringBuilder().append("Finished Loading Items").toString());
    }
    ...
    private static void setupFood() {
        ...
        // Proteins
        porkchopRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 40, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setUnlocalizedName("Porkchop");
        fishRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 40, false, true)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setUnlocalizedName("Fish");
        beefRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 50, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setUnlocalizedName("Beef");
        chickenRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 40, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
        ...
        eggCooked = new ItemFoodTFC(EnumFoodGroup.Protein, 0, 0, 0, 0, 25)
                .setDecayRate(2.5f)
                .setUnlocalizedName("Egg Cooked");
        calamariRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 20, 0, 35, false, false)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setDecayRate(4.0f)
                .setUnlocalizedName("Calamari");
        muttonRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 40, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setUnlocalizedName("Mutton");
        venisonRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 5, 0, 0, 0, 50, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
                .setUnlocalizedName("Venison");
        horseMeatRaw = new ItemFoodMeat(EnumFoodGroup.Protein, 0, 0, 0, 0, 40, false, false)
                .setDecayRate(2.5f)
                .setCanSmoke()
                .setHasCookedIcon()
                .setSmokeAbsorbMultiplier(1F)
        ...
        // Dairy
        cheese = new ItemFoodTFC(EnumFoodGroup.Dairy, 0, 10, 20, 0, 35)
                .setDecayRate(0.5f)
                .setCanSmoke()
                .setSmokeAbsorbMultiplier(1F)
        ...
        // Grains
        wheatGrain = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20)
                .setDecayRate(0.5f)
                .setUnlocalizedName("Wheat Grain");
        barleyGrain = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 10, 20)
                .setDecayRate(0.5f)
                .setUnlocalizedName("Barley Grain");
        oatGrain = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20)
                .setDecayRate(0.5f)
                .setUnlocalizedName("Oat Grain");
        ryeGrain = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 15, 0, 5, 20)
                .setDecayRate(0.5f)
                .setUnlocalizedName("Rye Grain");
        riceGrain = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20)
                .setDecayRate(0.5f)
                .setUnlocalizedName("Rice Grain");
        maizeEar = new ItemFoodTFC(EnumFoodGroup.Grain, 25, 0, 0, 5, 20, true).setUnlocalizedName("Maize Ear");

        wheatWhole = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Wheat Whole");
        barleyWhole = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 10, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Barley Whole");
        oatWhole = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Oat Whole");
        ryeWhole = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 15, 0, 5, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Rye Whole");
        riceWhole = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Rice Whole");

        wheatGround = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 0, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Wheat Ground");
        barleyGround = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Barley Ground");
        oatGround = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 0, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Oat Ground");
        ryeGround = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 15, 0, 0, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Rye Ground");
        riceGround = new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 0, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Rice Ground");
        cornmealGround = new ItemFoodTFC(EnumFoodGroup.Grain, 25, 0, 0, 0, 20, false, false)
                .setFolder("food/")
                .setUnlocalizedName("Cornmeal Ground");

        wheatDough =
                new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 0, 20, false, false).setUnlocalizedName("Wheat Dough");
        barleyDough =
                new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 5, 20, false, false).setUnlocalizedName("Barley Dough");
        ...
        riceDough =
                new ItemFoodTFC(EnumFoodGroup.Grain, 10, 0, 0, 0, 20, false, false).setUnlocalizedName("Rice Dough");
        ...
        onion = new ItemFoodTFC(EnumFoodGroup.Vegetable, 10, 25, 0, 0, 20, true) {
            ...
            public void registerIcons(IIconRegister registerer) {
                ...
                this.metaIcons[0] = registerer.registerIcon(Reference.MOD_ID + ":" + textureFolder
        ...
        greenBellPepper =
                new ItemFoodTFC(EnumFoodGroup.Vegetable, 10, 0, 0, 0, 20, true).setUnlocalizedName("Green Bell Pepper");
        yellowBellPepper = new ItemFoodTFC(EnumFoodGroup.Vegetable, 15, 0, 0, 0, 20, true)
                .setUnlocalizedName("Yellow Bell Pepper");
        redBellPepper =
                new ItemFoodTFC(EnumFoodGroup.Vegetable, 20, 0, 0, 0, 20, true).setUnlocalizedName("Red Bell Pepper");
        ...
        sugar = new ItemFoodTFC(EnumFoodGroup.None, 30, 0, 0, 0, 0, true)
                .setDecayRate(0.01f)
                .setUnlocalizedName("Sugar");

        // Fruit are in the foodID range of 50,000
        redApple = new ItemFoodTFC(EnumFoodGroup.Fruit, 25, 5, 0, 10, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[0]);
        banana = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 5, 0, 0, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[1]);
        orange = new ItemFoodTFC(EnumFoodGroup.Fruit, 50, 30, 0, 10, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[2]);
        greenApple = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 15, 0, 10, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[3]);
        lemon = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 50, 0, 10, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[4]);
        olive = new ItemFoodTFC(EnumFoodGroup.Fruit, 10, 0, 3, 10, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[5]);
        cherry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 5, 0, 0, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[6]);
        peach = new ItemFoodTFC(EnumFoodGroup.Fruit, 25, 10, 0, 0, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[7]);
        plum = new ItemFoodTFC(EnumFoodGroup.Fruit, 20, 15, 0, 0, 0, true)
                .setDecayRate(2.0f)
                .setUnlocalizedName(Global.FRUIT_META_NAMES[8]);

        wintergreenBerry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 0, 0, 20, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Wintergreen Berry");
        blueberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 20, 0, 0, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Blueberry");
        raspberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 35, 15, 0, 5, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Raspberry");
        strawberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 5, 0, 5, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Strawberry");
        blackberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 30, 0, 0, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Blackberry");
        bunchberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 20, 5, 0, 0, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Bunchberry");
        cranberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 30, 5, 0, 45, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Cranberry");
        snowberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 10, 0, 0, 90, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Snowberry");
        elderberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 20, 40, 0, 10, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Elderberry");
        gooseberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 20, 40, 0, 0, 0)
                .setDecayRate(2.0f)
                .setUnlocalizedName("Gooseberry");
        cloudberry = new ItemFoodTFC(EnumFoodGroup.Fruit, 40, 40, 0, 30, 0)
                .setDecayRate(2.0f)
        ...
        sugarcane = new ItemFoodTFC(EnumFoodGroup.None, 30, 0, 0, 0, 0, false, false)
                .setDecayRate(0.75f)
                .setFolder("plants/")
        ...
        seedsOnion =
                new ItemCustomSeeds(8).setUnlocalizedName(TFCOptions.onionsAreGross ? "Seeds Rutabaga" : "Seeds Onion");
    ...
    private static void registerMetals() {
        ...
        Global.STERLINGSILVER =
                new Metal("Sterling Silver", TFCItems.sterlingSilverUnshaped, TFCItems.sterlingSilverIngot);
        ...
        Global.HCBLACKSTEEL =
                new Metal("HC Black Steel", TFCItems.highCarbonBlackSteelUnshaped, TFCItems.highCarbonBlackSteelIngot);
        Global.WEAKREDSTEEL = new Metal("Weak Red Steel", TFCItems.weakRedSteelUnshaped, TFCItems.weakRedSteelIngot);
        Global.HCREDSTEEL =
                new Metal("HC Red Steel", TFCItems.highCarbonRedSteelUnshaped, TFCItems.highCarbonRedSteelIngot);
        Global.WEAKBLUESTEEL =
                new Metal("Weak Blue Steel", TFCItems.weakBlueSteelUnshaped, TFCItems.weakBlueSteelIngot);
        Global.HCBLUESTEEL =
                new Metal("HC Blue Steel", TFCItems.highCarbonBlueSteelUnshaped, TFCItems.highCarbonBlueSteelIngot);
    ...
    public static void setupArmor() {
        ...
        bismuthSheet =
                ((ItemMetalSheet) new ItemMetalSheet(0).setUnlocalizedName("Bismuth Sheet")).setMetal("Bismuth", 200);
        ...
        blueSteelSheet = ((ItemMetalSheet) new ItemMetalSheet(4).setUnlocalizedName("Blue Steel Sheet"))
                .setMetal("Blue Steel", 200);
        bronzeSheet =
                ((ItemMetalSheet) new ItemMetalSheet(6).setUnlocalizedName("Bronze Sheet")).setMetal("Bronze", 200);
        copperSheet =
                ((ItemMetalSheet) new ItemMetalSheet(7).setUnlocalizedName("Copper Sheet")).setMetal("Copper", 200);
        ...
        bismuthBronzeSheet2x = ((ItemMetalSheet2x)
                        new ItemMetalSheet2x(1).setUnlocalizedName("Bismuth Bronze Double Sheet"))
                .setMetal("Bismuth Bronze", 400);
        blackBronzeSheet2x = ((ItemMetalSheet2x)
                        new ItemMetalSheet2x(2).setUnlocalizedName("Black Bronze Double Sheet"))
                .setMetal("Black Bronze", 400);
        ...
        copperSheet2x = ((ItemMetalSheet2x) new ItemMetalSheet2x(7).setUnlocalizedName("Copper Double Sheet"))
                .setMetal("Copper", 400);
        wroughtIronSheet2x = ((ItemMetalSheet2x)
                        new ItemMetalSheet2x(9).setUnlocalizedName("Wrought Iron Double Sheet"))
                .setMetal("Wrought Iron", 400);
        ...
        sterlingSilverSheet =
                new ItemMetalSheet(18).setMetal("Sterling Silver", 200).setUnlocalizedName(namesNSO[i++] + " Sheet");

        i = 0;
        brassSheet2x =
                new ItemMetalSheet2x(5).setMetal("Brass", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        goldSheet2x = new ItemMetalSheet2x(8).setMetal("Gold", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        leadSheet2x =
                new ItemMetalSheet2x(10).setMetal("Lead", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        nickelSheet2x =
                new ItemMetalSheet2x(1).setMetal("Nickel", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        pigIronSheet2x =
                new ItemMetalSheet2x(12).setMetal("Pig Iron", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        platinumSheet2x =
                new ItemMetalSheet2x(13).setMetal("Platinum", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        silverSheet2x =
                new ItemMetalSheet2x(16).setMetal("Silver", 400).setUnlocalizedName(namesNSO[i++] + " Double Sheet");
        sterlingSilverSheet2x = new ItemMetalSheet2x(18)
                .setMetal("Sterling Silver", 400)
                .setUnlocalizedName(namesNSO[i++] + " Double Sheet");

        i = 0;
        bismuthBronzeUnfinishedBoots = new ItemUnfinishedArmor()
                .setMetal("Bismuth Bronze", 3)
                .setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        blackBronzeUnfinishedBoots = new ItemUnfinishedArmor()
                .setMetal("Black Bronze", 3)
                .setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        blackSteelUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Black Steel", 3).setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        blueSteelUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Blue Steel", 3).setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        bronzeUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Bronze", 3).setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        copperUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Copper", 3).setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        wroughtIronUnfinishedBoots = new ItemUnfinishedArmor()
                .setMetal("Wrought Iron", 3)
                .setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        redSteelUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Red Steel", 3).setUnlocalizedName(names[i] + " Unfinished Boots");
        i++;
        steelUnfinishedBoots =
                new ItemUnfinishedArmor().setMetal("Steel", 3).setUnlocalizedName(names[i] + " Unfinished Boots");

        i = 0;
        bismuthBronzeBoots = new ItemTFCArmor(
                        Armor.bismuthBronzePlate, proxy.getArmorRenderID("bismuthbronze"), 3, 50, 0)
        ...
        i = 0;
        bismuthBronzeUnfinishedGreaves = new ItemUnfinishedArmor()
                .setMetal("Bismuth Bronze", 2)
                .setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        blackBronzeUnfinishedGreaves = new ItemUnfinishedArmor()
                .setMetal("Black Bronze", 2)
                .setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        blackSteelUnfinishedGreaves = new ItemUnfinishedArmor()
                .setMetal("Black Steel", 2)
                .setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        blueSteelUnfinishedGreaves = new ItemUnfinishedArmor()
                .setMetal("Blue Steel", 2)
                .setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        bronzeUnfinishedGreaves =
                new ItemUnfinishedArmor().setMetal("Bronze", 2).setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        copperUnfinishedGreaves =
                new ItemUnfinishedArmor().setMetal("Copper", 2).setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        wroughtIronUnfinishedGreaves = new ItemUnfinishedArmor()
                .setMetal("Wrought Iron", 2)
                .setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        redSteelUnfinishedGreaves =
                new ItemUnfinishedArmor().setMetal("Red Steel", 2).setUnlocalizedName(names[i] + " Unfinished Greaves");
        i++;
        steelUnfinishedGreaves =
                new ItemUnfinishedArmor().setMetal("Steel", 2).setUnlocalizedName(names[i] + " Unfinished Greaves");

        i = 0;
        bismuthBronzeGreaves = new ItemTFCArmor(
                        Armor.bismuthBronzePlate, proxy.getArmorRenderID("bismuthbronze"), 2, 50, 1)
        ...
        i = 0;
        bismuthBronzeUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Bismuth Bronze", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        blackBronzeUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Black Bronze", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        blackSteelUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Black Steel", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        blueSteelUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Blue Steel", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        bronzeUnfinishedChestplate =
                new ItemUnfinishedArmor().setMetal("Bronze", 1).setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        copperUnfinishedChestplate =
                new ItemUnfinishedArmor().setMetal("Copper", 1).setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        wroughtIronUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Wrought Iron", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        redSteelUnfinishedChestplate = new ItemUnfinishedArmor()
                .setMetal("Red Steel", 1)
                .setUnlocalizedName(names[i] + " Unfinished Chestplate");
        i++;
        steelUnfinishedChestplate =
                new ItemUnfinishedArmor().setMetal("Steel", 1).setUnlocalizedName(names[i] + " Unfinished Chestplate");

        i = 0;
        bismuthBronzeChestplate = new ItemTFCArmor(
                        Armor.bismuthBronzePlate, proxy.getArmorRenderID("bismuthbronze"), 1, 50, 2)
                .setUnlocalizedName(names[i] + " Chestplate");
        i++;
        blackBronzeChestplate = new ItemTFCArmor(
                        Armor.blackBronzePlate, proxy.getArmorRenderID("blackbronze"), 1, 50, 2)
                .setUnlocalizedName(names[i] + " Chestplate");
        i++;
        ...
        wroughtIronChestplate = new ItemTFCArmor(
                        Armor.wroughtIronPlate, proxy.getArmorRenderID("wroughtiron"), 1, 50, 2)
                .setUnlocalizedName(names[i] + " Chestplate");
        i++;
        ...
        i = 0;
        bismuthBronzeUnfinishedHelmet = new ItemUnfinishedArmor()
                .setMetal("Bismuth Bronze", 0)
                .setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        blackBronzeUnfinishedHelmet = new ItemUnfinishedArmor()
                .setMetal("Black Bronze", 0)
                .setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        blackSteelUnfinishedHelmet = new ItemUnfinishedArmor()
                .setMetal("Black Steel", 0)
                .setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        blueSteelUnfinishedHelmet =
                new ItemUnfinishedArmor().setMetal("Blue Steel", 0).setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        bronzeUnfinishedHelmet =
                new ItemUnfinishedArmor().setMetal("Bronze", 0).setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        copperUnfinishedHelmet =
                new ItemUnfinishedArmor().setMetal("Copper", 0).setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        wroughtIronUnfinishedHelmet = new ItemUnfinishedArmor()
                .setMetal("Wrought Iron", 0)
                .setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        redSteelUnfinishedHelmet =
                new ItemUnfinishedArmor().setMetal("Red Steel", 0).setUnlocalizedName(names[i] + " Unfinished Helmet");
        i++;
        steelUnfinishedHelmet =
                new ItemUnfinishedArmor().setMetal("Steel", 0).setUnlocalizedName(names[i] + " Unfinished Helmet");

        i = 0;
        bismuthBronzeHelmet = new ItemTFCArmor(
                        Armor.bismuthBronzePlate, proxy.getArmorRenderID("bismuthbronze"), 0, 50, 3)
        ...
        leatherHelmet = new ItemTFCArmor(
                        Armor.leather, proxy.getArmorRenderID("leather"), 0, ArmorMaterial.CLOTH, 100, 3)
                .setUnlocalizedName("helmetCloth")
                .setTextureName("leather_helmet");
        leatherChestplate = new ItemTFCArmor(
                        Armor.leather, proxy.getArmorRenderID("leather"), 1, ArmorMaterial.CLOTH, 100, 2)
                .setUnlocalizedName("chestplateCloth")
                .setTextureName("leather_chestplate");
        leatherLeggings = new ItemTFCArmor(
                        Armor.leather, proxy.getArmorRenderID("leather"), 2, ArmorMaterial.CLOTH, 100, 1)
                .setUnlocalizedName("leggingsCloth")
                .setTextureName("leather_leggings");
        leatherBoots = new ItemTFCArmor(
                        Armor.leather, proxy.getArmorRenderID("leather"), 3, ArmorMaterial.CLOTH, 100, 0)
