...
public class ContainerLiquidVessel extends ContainerTFC {
    ...
    public void detectAndSendChanges() {
        ...
        if (nbt != null) {
            ...
            if (input != null
                    && input.getItem() instanceof ItemPotteryMold
            ...
            if (!world.isRemote && m != null && stack != null) {
                if (input != null
                        && input.getItem() == TFCItems.ceramicMold
                    ...
                    TFC_ItemHeat.setTemp(
                            input, (short) (HeatRegistry.getInstance().getMeltingPoint(input) * 1.5f));
                    if (metalAmount - 1 <= 0) {
                        nbt.removeTag("MetalType");
                        nbt.removeTag("MetalAmount");
                        nbt.removeTag("TempTimer");
                        ...
                        && input.stackSize == 1
                        && metalAmount > 0
                        && ("Copper".equals(m.name)
                                || "Bronze".equals(m.name)
                    ...
                    else if ("Bronze".equals(m.name) && (input.getItemDamage() - 2) % 4 == 1) correctMetalFlag = true;
