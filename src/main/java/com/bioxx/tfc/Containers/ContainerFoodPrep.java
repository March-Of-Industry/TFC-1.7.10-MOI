...
public class ContainerFoodPrep extends ContainerTFC {
    ...
    protected void layoutContainer(IInventory playerInventory, IInventory chestInventory, int xSize, int ySize) {
        if (guiTab == 0) {
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 0, 44, 24)
                    .addItemInclusion(
                            TFCItems.wheatBread,
            ...
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 1, 62, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 2, 80, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 3, 98, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 4, 116, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            ...
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 1, 53, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 2, 71, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 3, 89, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
            this.addSlotToContainer(new SlotFoodOnly(chestInventory, 4, 107, 24)
                    .addItemException(TFCItems.woodenBucketMilk)
                    .setSize(EnumSize.HUGE));
