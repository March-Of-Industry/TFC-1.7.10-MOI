...
public class ContainerPlayerTFC extends ContainerPlayer {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotNum) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            // From crafting grid input to inventory
                    ...
                    || player.getEntityData().hasKey("craftingTable") && slotNum >= 45 && slotNum < 50) {
            ...
            // Food from inventory/hotbar to crafting grid
                ...
                if (!this.mergeItemStack(slotStack, 1, 5, false, false) && slotStack.stackSize == 0) return null;
                        ...
                        && !this.mergeItemStack(slotStack, 45, 50, false)) return null;
    ...
    protected boolean mergeItemStack(
            ItemStack is, int slotStart, int slotFinish, boolean reverseOrder, boolean craftingOutput) {
