...
public class ContainerFirepit extends ContainerTFC {
    ...
    public ContainerFirepit(
            InventoryPlayer inventoryplayer, TEFirepit tileentityfirepit, World world, int x, int y, int z) {
    ...
    public ItemStack transferStackInSlotTFC(EntityPlayer player, int slotNum) {
        ...
        Slot[] slotfuel = {
            (Slot) inventorySlots.get(1),
            (Slot) inventorySlots.get(3),
            (Slot) inventorySlots.get(4),
