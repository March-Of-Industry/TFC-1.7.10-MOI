...
public class ContainerWorkbench extends ContainerTFC {
    ...
    public ContainerWorkbench(
            InventoryPlayer par1InventoryPlayer, TEWorkbench wb, World par2World, int par3, int par4, int par5) {
    ...
    public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
        return this.worldObj.getBlock(this.posX, this.posY, this.posZ) != TFCBlocks.workbench
                ? false
