...
public class ContainerBarrel extends ContainerTFC {
    ...
    public ContainerBarrel(
            InventoryPlayer inventoryplayer, TEBarrel tileentitybarrel, World world, int x, int y, int z, int tab) {
    ...
    protected void buildLayout() {
        if (guiTab == 0) {
            ...
            if (!barrel.getSealed())
                addSlotToContainer(
                        new SlotChest(barrel, 0, 80, 29).setSize(EnumSize.LARGE).addItemException(getExceptions()));
    ...
    public void detectAndSendChanges() {
        ...
        for (int var1 = 0; var1 < this.crafters.size() && guiTab == 0; ++var1) {
            ...
            if (this.barrel.getFluidStack() != null
