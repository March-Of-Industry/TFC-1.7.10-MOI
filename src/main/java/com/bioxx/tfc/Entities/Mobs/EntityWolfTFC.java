...
public class EntityWolfTFC extends EntityWolf implements IAnimal, IInnateArmor, ICausesDamage {
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        int damage =
                (int) (TFC_MobData.WOLF_DAMAGE * getStrengthMod() * getAggressionMod() * (getSizeMod() / 2 + 0.5F));
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        this.entityDropItem(
                new ItemStack(TFCItems.hide, 1, Math.max(0, Math.min(2, (int) (sizeMod * ageMod * 0.9)))), 0);
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null) {
            if (this.isBreedingItemTFC(itemstack)
                ...
                if (!player.capabilities.isCreativeMode) {
                    player.inventory.setInventorySlotContents(
                            player.inventory.currentItem,
                            ((ItemFoodTFC) itemstack.getItem())
                                    .onConsumedByEntity(player.getHeldItem(), worldObj, this));
                }

                this.func_146082_f(player);
                return true;
            } else if (itemstack.getItem() instanceof ItemCustomNameTag
    ...
    public boolean isFood(ItemStack item) {
        return item != null
                && (item.getItem() == TFCItems.beefRaw
                        || item.getItem() == TFCItems.chickenRaw
    ...
    public void setTamed(boolean par1) {
        if (this.familiarity > 80 && !this.isTamed()) {
            ...
            double healthRatio = this.getHealth()
