        ...
        if (!this.worldObj.isRemote && var1 > 1 && this.getHealth() <= 0) {
            ...
            for (int var3 = 0; var3 < var2; ++var3) {
                ...
                var6.setLocationAndAngles(
                        this.posX + var4, this.posY + 0.5D, this.posZ + var5, this.rand.nextFloat() * 360.0F, 0.0F);
        ...
        if (this.canDamagePlayer()) {
            ...
            if (this.canEntityBeSeen(par1EntityPlayer)
                ...
                this.worldObj.playSoundAtEntity(
                        this, "mob.slime.attack", 1.0F, (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
        }
    }
