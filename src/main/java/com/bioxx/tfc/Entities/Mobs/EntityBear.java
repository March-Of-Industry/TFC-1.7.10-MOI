...
public class EntityBear extends EntityTameable implements ICausesDamage, IAnimal, IInnateArmor {
    ...
    private static final int FAMILIARITY_CAP =
            80; // Adult bears cap out at 80 since it is currently impossible to get baby bears.
    ...
    public void handleFamiliarityUpdate() {
        ...
        if (lastFamiliarityUpdate < totalDays) {
            if (familiarizedToday && familiarity < 100) {
                ...
                float familiarityChange = 3
                        * obedienceMod
                        / aggressionMod; // Changed from 6 to 3 so bears are harder to tame by default. -Kitty
