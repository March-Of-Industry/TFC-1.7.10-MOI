...
public class EntitySheepTFC extends EntitySheep implements IShearable, IAnimal {
    ...
    private final InventoryCrafting colorCrafting = new InventoryCrafting(
            new Container() {
                @Override
    ...
    public int combineColors(EntityAnimal parent, int mateColor) {
        ...
        ItemStack itemstack =
                CraftingManager.getInstance().findMatchingRecipe(this.colorCrafting, ((EntitySheep) parent).worldObj);
        int babyColor;
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        if (!this.getSheared())
            this.entityDropItem(
                    new ItemStack(TFCItems.sheepSkin, 1, Math.max(0, Math.min(2, (int) (ageMod * sizeMod)))), 0.0F);
        else
            this.entityDropItem(
                    new ItemStack(TFCItems.hide, 1, Math.max(0, Math.min(2, (int) (ageMod * sizeMod)))), 0.0F);
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(
                24, String.valueOf("0")); // Time of conception, stored as a string since we can't do long
    }
    ...
    public boolean interact(EntityPlayer player) {
        if (!worldObj.isRemote) {
            ...
            if (player.getHeldItem() != null
                    && player.getHeldItem().getItem() instanceof ItemKnife
                    && !getSheared()
