...
public class EntityStand extends EntityLiving {
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(
                start + EntityStand.defaultEquipableLength + EntityStand.defaultArmorLength, new Float(1));
        this.dataWatcher.addObject(
                start + EntityStand.defaultEquipableLength + EntityStand.defaultArmorLength + 1, Integer.valueOf(0));
    }
        ...
        if (dataWatcher != null) {
            if (this.worldObj.isRemote) {
                ...
                this.dataWatcher.updateObject(
                        start + EntityStand.defaultEquipableLength + EntityStand.defaultArmorLength, rotation);
                this.dataWatcher.updateObject(
                        start + EntityStand.defaultEquipableLength + EntityStand.defaultArmorLength + 1, woodType);
            }
        }
    }
    ...
    public boolean interact(EntityPlayer ep) {
        if (!worldObj.isRemote) {
            ...
            if (is != null) {
                ...
                double angleTan =
                        hitVec.yCoord / Math.sqrt(hitVec.xCoord * hitVec.xCoord + hitVec.zCoord * hitVec.zCoord);
