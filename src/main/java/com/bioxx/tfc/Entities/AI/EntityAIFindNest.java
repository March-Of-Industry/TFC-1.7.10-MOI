...
public class EntityAIFindNest extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (theCreature instanceof EntityChickenTFC && !(theCreature instanceof EntityPheasantTFC)) {
            return ((EntityChickenTFC) theCreature).isAdult()
                    && ((EntityChickenTFC) theCreature).getFamiliarity() >= 15
                    && this.theWorld.getBlock((int) theCreature.posX, (int) theCreature.posY, (int) theCreature.posZ)
                            != TFCBlocks.nestBox
                    && this.theWorld.getBlock(
                                    (int) theCreature.posX, (int) theCreature.posY - 1, (int) theCreature.posZ)
                            != TFCBlocks.nestBox
    ...
    public boolean continueExecuting() {
        ...
        return this.currentTick <= this.maxSittingTicks
                && this.movement <= 60
                && this.isSittableBlock(
                        this.theCreature.worldObj, this.sitableBlockX, this.sitableBlockY, this.sitableBlockZ);
    }
    ...
    public void startExecuting() {
        ...
        this.maxSittingTicks =
                this.theCreature.getRNG().nextInt(this.theCreature.getRNG().nextInt(1200) + 1200) + 1200;
    }
    ...
    public void updateTask() {
        ...
        if (this.theCreature.getDistanceSq(this.sitableBlockX, this.sitableBlockY + 1, this.sitableBlockZ) > 1.0D) {
            ...
            this.compoundDistance += this.theCreature.getDistance(
                    this.theCreature.lastTickPosX, this.theCreature.lastTickPosY, this.theCreature.lastTickPosZ);
            if (this.currentTick - 40 > this.lastCheckedTick) {
                ArrayList<EntityChickenTFC> crowd =
                        (ArrayList<EntityChickenTFC>) theCreature.worldObj.getEntitiesWithinAABB(
                                EntityChickenTFC.class, theCreature.boundingBox.expand(24, 2, 24));
