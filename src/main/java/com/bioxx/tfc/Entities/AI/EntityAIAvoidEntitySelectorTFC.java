...
class EntityAIAvoidEntitySelectorTFC implements IEntitySelector {
    ...
    public boolean isEntityApplicable(Entity par1Entity) {
        ...
        Vec3 distanceVec = Vec3.createVectorHelper(
                creature.posX - par1Entity.posX, creature.posY - par1Entity.posY, creature.posZ - par1Entity.posZ);
        double cosAngleAbs = Math.abs(distanceVec.dotProduct(creature.getLookVec())
                / (distanceVec.lengthVector() * creature.getLookVec().lengthVector()));
