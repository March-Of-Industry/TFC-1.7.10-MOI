...
public class RenderPlayerTFC extends RenderPlayer {
     ...
     */
    @Override
    protected int shouldRenderPass /*setArmorModel*/(
            AbstractClientPlayer par1AbstractClientPlayer, int slotIndex, float partialTick) {
        ItemStack itemstack;
        ...
        if (itemstack != null) {
            ...
            if (item instanceof ItemArmor) {
                ...
                modelbiped.bipedHeadwear.showModel = slotIndex == 0
