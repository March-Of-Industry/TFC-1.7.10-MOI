...
public class RenderLoom implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(
        ...
        this.setRotatedRenderBounds(
                renderer, te.rotation, MIN_X + 0.1F, MIN_Y, MIN_Z + 0.75F, MAX_X - 0.8F, MAX_Y, MAX_Z - 0.15F);
        renderer.renderStandardBlock(materialBlock, x, y, z);

        this.setRotatedRenderBounds(
                renderer, te.rotation, MIN_X + 0.8F, MIN_Y, MIN_Z + 0.75F, MAX_X - 0.1F, MAX_Y, MAX_Z - 0.15F);
        renderer.renderStandardBlock(materialBlock, x, y, z);
        ...
        this.setRotatedRenderBounds(
                renderer, te.rotation, MAX_X - 0.8F, 0F, MIN_Z + 0.75F, MIN_X + 0.8F, MIN_Y + 0.1F, MAX_Z - 0.15F);
        renderer.renderStandardBlock(materialBlock, x, y, z);
