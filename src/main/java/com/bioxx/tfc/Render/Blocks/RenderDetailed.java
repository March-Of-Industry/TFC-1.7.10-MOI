...
public class RenderDetailed {
    ...
    public static boolean renderBlockDetailed(Block block, int i, int j, int k, RenderBlocks renderblocks) {
        ...
        IIcon myTexture = renderblocks.overrideBlockTexture == null
                ? Block.getBlockById(te.typeID).getIcon(0, te.metaID)
    ...
    private static void renderMiniBlock(
            Block block, int i, int j, int k, int x, int y, int z, TEDetailed te, int type, int meta, IIcon myTexture) {
