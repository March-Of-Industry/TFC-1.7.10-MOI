...
public class RenderHopper implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(
        ...
        return this.renderBlockHopperMetadata(
                block, x, y, z, renderer.blockAccess.getBlockMetadata(x, y, z), false, renderer);
    }

    public boolean renderBlockHopperMetadata(
            Block block, int x, int y, int z, int meta, boolean unknownBool, RenderBlocks renderer) {
        Tessellator tessellator = Tessellator.instance;
