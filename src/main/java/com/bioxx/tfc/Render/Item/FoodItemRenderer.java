    ...
    public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
        ...
        if (is.getItem() instanceof IFood && is.hasTagCompound()) {
            ...
            if (is.getItem() instanceof ItemFoodTFC) {
                ...
                else renderIcon(0, 0, is.getItem().getIconIndex(is), 16, 16);
            }
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (type == ItemRenderType.INVENTORY) {
                ...
                if (weightPerc
                        <= 1) // Only draw bars if the weight is within the max weight. Food created using the blank
                // createTag (weight = 999) will not have the bars.
                {
