...
public class RenderPheasantTFC extends RenderChicken {
    private static final ResourceLocation FEMALE_TEXTURE =
            new ResourceLocation(Reference.MOD_ID, "textures/mob/PheasantF.png");
    private static final ResourceLocation MALE_TEXTURE =
            new ResourceLocation(Reference.MOD_ID, "textures/mob/PheasantM.png");
    private static final ResourceLocation CHICK_TEXTURE =
            new ResourceLocation(Reference.MOD_ID, "textures/mob/pheasant_chick.png");
