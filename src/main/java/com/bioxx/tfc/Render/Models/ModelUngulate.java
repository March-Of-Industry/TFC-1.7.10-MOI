...
public class ModelUngulate extends ModelBase {
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6) {
        ...
        // float BLL = par1;
        float speedMod =
                Math.min(Math.abs(Math.max(Math.abs(par2), 0.001F)), 1F) * (par2 != 0 ? par2 / Math.abs(par2) : 1);
        ...
        if (MathHelper.cos(frontRightLeg * 0.6662F + (float) Math.PI / 2F) * 1.4F * speedMod > 0) {
            rightArm.rotateAngleX = MathHelper.cos(frontRightLeg * 0.6662F + (float) Math.PI / 2F) * 1.4F * speedMod
                    + rightArmInitAngle;
            leftCalf.rotateAngleX = MathHelper.cos(frontRightLeg * 0.6662F + (float) Math.PI / 2F)
                            * 0.7F
        ...
        if (MathHelper.cos(frontLeftLeg * 0.6662F + (float) Math.PI / 2F) * 1.4F * speedMod > 0) {
            leftArm.rotateAngleX =
                    MathHelper.cos(frontLeftLeg * 0.6662F + (float) Math.PI / 2F) * 1.4F * speedMod + leftArmInitAngle;
            rightCalf.rotateAngleX = MathHelper.cos(frontLeftLeg * 0.6662F + (float) Math.PI / 2F)
                            * 0.7F
        ...
        rightFoot.rotateAngleX = MathHelper.sin(frontLeftLeg * 0.6662F)
                        * 0.7F
        ...
        leftFoot.rotateAngleX = MathHelper.sin(frontRightLeg * 0.6662F)
                        * 0.7F
