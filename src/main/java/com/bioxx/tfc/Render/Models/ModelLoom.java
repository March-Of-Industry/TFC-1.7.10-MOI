...
public class ModelLoom extends ModelBase {
    ...
    public void render(
            ...
            int numMaxStrings,
            int tick,
            boolean shouldClothIncrease,
            int tickMod,
            ResourceLocation stringTex,
            boolean isWeaving,
            boolean stillWeaving,
            TELoom te) {
        ...
        float string1Length =
                (float) Math.sqrt(Math.pow(stringStartZ - string1Z, 2) + Math.pow(pole1StringY - pole1Height, 1));
        float string2Length =
                (float) Math.sqrt(Math.pow(stringStartZ - string2Z, 2) + Math.pow(pole2StringY - pole2Height, 1));
        ...
        for (int i = 0; i < numStrings; i += 2) {
            ...
            vert1 = new PositionTextureVertex(
                    stringStartX + stringWidth + (i * stringWidth), pole2StringY, stringStartZ, 0, 8);
            vert2 = new PositionTextureVertex(stringStartX + (i * stringWidth), pole2Height, string2Z, 8, 0);
            vert3 = new PositionTextureVertex(
                    stringStartX + stringWidth + (i * stringWidth), pole2Height, string2Z, 8, 8);

            initialString[i] = new TexturedQuad(
                    new PositionTextureVertex[] {vert2, vert3, vert1, vert0}, 0, 0, 1, (int) string2Length, 16, 16);

            // final
            vert0 = new PositionTextureVertex(stringStartX + (i * stringWidth), pole2Height, string2Z, 0, 0);
            vert1 = new PositionTextureVertex(
                    stringStartX + stringWidth + (i * stringWidth), pole2Height, string2Z, 0, 8);
            ...
            vert1 = new PositionTextureVertex(
                    stringStartX + stringWidth + ((i + 1) * stringWidth), pole1StringY, stringStartZ, 0, 8);
            vert2 = new PositionTextureVertex(stringStartX + ((i + 1) * stringWidth), pole1Height, string1Z, 8, 0);
            vert3 = new PositionTextureVertex(
                    stringStartX + stringWidth + ((i + 1) * stringWidth), pole1Height, string1Z, 8, 8);
            if (i + 1 < numStrings) {
                initialString[i + 1] = new TexturedQuad(
                        new PositionTextureVertex[] {vert2, vert3, vert1, vert0}, 0, 0, 1, (int) string1Length, 16, 16);
                // final
                vert0 = new PositionTextureVertex(stringStartX + ((i + 1) * stringWidth), pole1Height, string1Z, 0, 0);
                vert1 = new PositionTextureVertex(
                        stringStartX + stringWidth + ((i + 1) * stringWidth), pole1Height, string1Z, 0, 8);
                vert2 = new PositionTextureVertex(stringStartX + ((i + 1) * stringWidth), 0, stringStartZ, 8, 0);
                vert3 = new PositionTextureVertex(
                        stringStartX + stringWidth + ((i + 1) * stringWidth), 0, stringStartZ, 8, 8);
        ...
        vert3 = new PositionTextureVertex(
                stringStartX + (numStrings * stringWidth), 14.5F - (cloth * stringWidth), stringStartZ, 8, 8);

        clothRender =
                new TexturedQuad(new PositionTextureVertex[] {vert0, vert1, vert3, vert2}, 0, 0, 16, cloth, 16, 16);
        GL11.glPushMatrix();
