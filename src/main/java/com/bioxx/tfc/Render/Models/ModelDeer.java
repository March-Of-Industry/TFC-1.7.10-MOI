...
public class ModelDeer extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        setRotation(
                neck, f4 / (1.5F * (180F / (float) Math.PI)) + 1.815142F, f3 / (1.5F * (180F / (float) Math.PI)), 0F);
        setRotation(rump, -0.0872665F, 0F, 0F);
        setRotation(body, 1.43117F, 0F, 0F);
        ...
        if (!running) {
            ...
            if (MathHelper.sin(f / 1.5F + (float) Math.PI * 7F / 4F) * 0.7F * f1 > 0) {
                ...
                setRotation(
                        leg1,
                        -MathHelper.sin(f / 1.5F + (float) Math.PI * 7F / 4F) * 1.4F * f1
                                - 22F / 180F * (float) Math.PI,
                        0F,
                        0F);
                setRotation(
                        toes1, MathHelper.sin(f / 1.5F + (float) Math.PI * 7F / 4F) * 2.1F * f1 + 1.134464F, 0F, 0F);
            }
            if (MathHelper.sin(f / 1.5F + 3f * (float) Math.PI / 4F) * 0.7F * f1 > 0) {
                ...
                setRotation(
                        leg2,
                        -MathHelper.sin(f / 1.5F + 3f * (float) Math.PI / 4F) * 1.4F * f1
                                - 22F / 180F * (float) Math.PI,
                        0F,
                        0F);
                setRotation(
                        toes2, MathHelper.sin(f / 1.5F + 3f * (float) Math.PI / 4F) * 2.1F * f1 + 1.134464F, 0F, 0F);
            }
            ...
            if (MathHelper.sin(f / 1.5F + (float) Math.PI / 2F - 3F * (float) Math.PI / 8) > 0) {
                ...
                setRotation(
                        toes3,
                        MathHelper.sin(f / 1.5F + (float) Math.PI / 2F - 3F * (float) Math.PI / 8) * 2.1F * f1
                                + 1.134464F,
                        0,
                        0);
            }
