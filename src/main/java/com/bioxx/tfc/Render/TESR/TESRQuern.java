...
public class TESRQuern extends TESRBase implements ISimpleBlockRenderingHandler {
    private static final ResourceLocation BASE_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Quern Base.png");
    private static final ResourceLocation TOP1_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Quern Top 1.png");
    private static final ResourceLocation TOP2_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Quern Top 2.png");
    private static final ResourceLocation WOOD_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/wood/Oak Plank.png");
    ...
    public void renderTileEntityAt(TileEntity te, double xDis, double yDis, double zDis, float f) {
        ...
        GL11.glPushMatrix();
        {
            ...
            if (teq.hasQuern) {
                 ...
                 */
                this.renderRoundTop(
                        tess, teq.rotatetimer, teq.getWorldObj().rand, 0.8, true); // Renders a round Quern top stone
    ...
    public boolean renderWorldBlock(
            IBlockAccess world, int i, int j, int k, Block block, int modelId, RenderBlocks renderblocks) {
        return false;
    }
