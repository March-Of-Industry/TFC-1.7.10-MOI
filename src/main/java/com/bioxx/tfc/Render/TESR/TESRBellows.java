...
public class TESRBellows extends TESRBase {
    private static final ResourceLocation FRONT_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows Front.png");
    private static final ResourceLocation BACK_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows Back.png");
    private static final ResourceLocation SIDE1_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows82.png");
    private static final ResourceLocation SIDE2_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows83.png");
    private static final ResourceLocation SIDE3_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows84.png");
    private static final ResourceLocation SIDE4_TEXTURE =
            new ResourceLocation(Reference.MOD_ID + ":textures/blocks/devices/Bellows85.png");
