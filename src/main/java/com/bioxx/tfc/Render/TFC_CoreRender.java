...
public class TFC_CoreRender {
    ...
    public static boolean renderBlockStairs(Block block, int x, int y, int z, RenderBlocks renderblocks) {
        ...
        IIcon myTexture = renderblocks.overrideBlockTexture == null
                ? Block.getBlockById(type).getIcon(0, temeta)
    ...
    public static boolean renderWoodTrunk(Block block, int i, int j, int k, RenderBlocks renderblocks) {
        ...
        if (blockAccess.getTileEntity(i, j, k) != null
                && (blockAccess.getBlock(i, j - 1, k) == TFCBlocks.fruitTreeWood
                        || blockAccess.getBlock(i, j - 1, k).isOpaqueCube())) {
            renderblocks.setRenderBounds(0.3F, 0.0F, 0.3F, 0.7F, 1.0F, 0.7F);
            renderblocks.renderStandardBlock(block, i, j, k);
        }
        if (blockAccess.getBlock(i - 1, j, k).getMaterial() == Material.leaves
                || blockAccess.getBlock(i - 1, j, k) == TFCBlocks.fruitTreeWood) {
        ...
        if (blockAccess.getBlock(i, j, k - 1).getMaterial() == Material.leaves
                || blockAccess.getBlock(i, j, k - 1) == TFCBlocks.fruitTreeWood) {
    ...
    public static boolean renderLooseRock(Block block, int i, int j, int k, RenderBlocks renderblocks) {
        ...
        renderblocks.setRenderBounds(
                0.35F + xOffset, 0.00F, 0.35F + zOffset, 0.65F + xOffset2, 0.15F + yOffset2, 0.65F + zOffset2);
        renderblocks.renderStandardBlock(block, i, j, k);
    ...
    public static boolean renderOre(
            Block block,
            int xCoord,
            int yCoord,
            int zCoord,
        ...
        if (!BlockSluice.isBlockFootOfBed(meta)) {
            if (dir == 0) {
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0, 0.0F, 0.0F + (0.25 * count), 1, 1.0F - (0.125 * count), 0.05F + (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0, 0.0F, 0.05F + (0.25 * count), 1, 0.8125 - (0.125 * count), 0.25F + (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                }
            } else if (dir == 1) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.95F - (0.25 * count), 0.0F, 0, 1.0F - (0.25 * count), 1.0F - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.75F - (0.25 * count), 0.0F, 0, 0.95F - (0.25 * count), 0.8125 - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                }
            } else if (dir == 2) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.0F, 0.0F, 0.95F - (0.25 * count), 1F, 1.0F - (0.125 * count), 1.0F - (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.0F, 0.0F, 0.75F - (0.25 * count), 1F, 0.8125F - (0.125 * count), 0.95F - (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                }
            } else if (dir == 3) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.0F + (0.25 * count), 0.0F, 0, 0.05F + (0.25 * count), 1.0F - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.05F + (0.25 * count), 0.0F, 0, 0.25F + (0.25 * count), 0.8125 - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                }
            }
        } else {
            if (dir == 0) {
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0, 0.0F, 0.0F + (0.25 * count), 1, 0.5F - (0.125 * count), 0.05F + (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0,
            ...
            if (dir == 1) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.95F - (0.25 * count), 0.0F, 0, 1.0F - (0.25 * count), 0.5F - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.75F - (0.25 * count),
            ...
            if (dir == 2) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.0F, 0.0F, 0.95F - (0.25 * count), 1F, 0.5F - (0.125 * count), 1.0F - (0.25 * count));
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.0F,
            ...
            if (dir == 3) {
                ...
                for (int count = 0; count < 4; count++) {
                    // ribs
                    renderblocks.setRenderBounds(
                            0.0F + (0.25 * count), 0.0F, 0, 0.05F + (0.25 * count), 0.5F - (0.125 * count), 1);
                    renderblocks.renderStandardBlock(block, i, j, k);
                    // body
                    renderblocks.setRenderBounds(
                            0.05F + (0.25 * count),
    ...
    public static boolean renderBlockWithCustomColorMultiplier(
            Block block, RenderBlocks renderBlocks, int xCoord, int yCoord, int zCoord, int colorMultiplier) {
        ...
        return Minecraft.isAmbientOcclusionEnabled() && block.getLightValue() == 0
                ? (renderBlocks.partialRenderBounds
                        ...
                        : renderBlocks.renderStandardBlockWithAmbientOcclusion(
                                block, xCoord, yCoord, zCoord, f, f1, f2))
                : renderBlocks.renderStandardBlockWithColorMultiplier(block, xCoord, yCoord, zCoord, f, f1, f2);
    }

    public static boolean renderFruitLeaves(
            Block block, int xCoord, int yCoord, int zCoord, RenderBlocks renderblocks) {
        ...
        renderblocks.renderStandardBlock(block, xCoord, yCoord, zCoord);
        if (index != null
                && (index.inBloom(TFC_Time.getSeasonAdjustedMonth(zCoord))
    ...
    public static boolean renderSeaPlant(Block par1Block, int par2, int par3, int par4, RenderBlocks renderblocks) {
        ...
        if (te instanceof TEWaterPlant) {
            ...
            if (wp.getBlockFromType() != null) {
                substrateRender = renderblocks.renderStandardBlockWithColorMultiplier(
                        wp.getBlockFromType(), par2, par3, par4, 1, 1, 1);
