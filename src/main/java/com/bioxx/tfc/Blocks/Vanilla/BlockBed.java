...
public class BlockBed extends BlockDirectional {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        this.bedTopIcons = new IIcon[] {
            par1IconRegister.registerIcon(Reference.MOD_ID + ":straw bed_feet_top"),
            par1IconRegister.registerIcon(Reference.MOD_ID + ":straw bed_head_top")
        };
        this.bedEndIcons = new IIcon[] {
            par1IconRegister.registerIcon(Reference.MOD_ID + ":straw bed_feet_end"),
            par1IconRegister.registerIcon(Reference.MOD_ID + ":straw bed_head_end")
        };
        this.bedSideIcons = new IIcon[] {
            par1IconRegister.registerIcon(Reference.MOD_ID + ":straw bed_feet_side"),
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5) {
        ...
        } else if (par1World.getBlock(par2 + FOOT_HEAD_BLOCKMAP[j1][0], par3, par4 + FOOT_HEAD_BLOCKMAP[j1][1])
                != this) {
            par1World.setBlockToAir(par2, par3, par4);
