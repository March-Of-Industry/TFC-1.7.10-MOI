...
public class BlockCustomCactus extends Block implements IPlantable {
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
        if (par1World.getBlock(par2 - 1, par3, par4).getMaterial().isSolid()) return false;
        else if (par1World.getBlock(par2 + 1, par3, par4).getMaterial().isSolid()) return false;
        else if (par1World.getBlock(par2, par3, par4 - 1).getMaterial().isSolid()) return false;
        else if (par1World.getBlock(par2, par3, par4 + 1).getMaterial().isSolid()) return false;
