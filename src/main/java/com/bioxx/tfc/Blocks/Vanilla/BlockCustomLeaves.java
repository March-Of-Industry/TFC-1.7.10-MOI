...
public class BlockCustomLeaves extends BlockLeaves implements IShearable {
    ...
    public void registerBlockIcons(IIconRegister iconRegisterer) {
        for (int i = 0; i < this.woodNames.length; i++) {
            this.icons[i] = iconRegisterer.registerIcon(
                    Reference.MOD_ID + ":" + "wood/trees/" + this.woodNames[i] + " Leaves Fancy");
            this.iconsOpaque[i] =
                    iconRegisterer.registerIcon(Reference.MOD_ID + ":" + "wood/trees/" + this.woodNames[i] + " Leaves");
        }
    }
