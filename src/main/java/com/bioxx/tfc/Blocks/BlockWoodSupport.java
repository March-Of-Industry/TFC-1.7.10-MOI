            ...
            if (!foundEV) {
                if (!checkConnection) {
                    if (world.isAirBlock(x + i, y, z) || TFCBlocks.isBlockVSupport(world.getBlock(x + i, y, z))) e++;
                        ...
                        && !TFCBlocks.isBlockHSupport(world.getBlock(x + i, y, z))
            ...
            if (!foundSV) {
                if (!checkConnection) {
                    if (world.isAirBlock(x, y, z + i) || TFCBlocks.isBlockVSupport(world.getBlock(x, y, z + i))) s++;
                        ...
                        && !TFCBlocks.isBlockHSupport(world.getBlock(x, y, z + i))
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, Block l) {
        ...
        if (isVertical && !isOtherHorizontal) // Vertical Beam
        {
            ...
            if (!world.getBlock(i, j - 1, k).isOpaqueCube()
                    && !TFCBlocks.isBlockVSupport(world.getBlock(i, j - 1, k))) {
    ...
    public boolean canPlaceBlockOnSide(World world, int x, int y, int z, int side) {
        ...
        if (!TFCBlocks.isBlockVSupport(downBlock)) {
            ...
            if (side == 1 && world.isAirBlock(x, y, z)) return true;
                    ...
                    && (TFCBlocks.isBlockVSupport(world.getBlock(x, y, z - 1))
                            || world.getBlock(x, y, z - 1).isOpaqueCube())
                    && world.isAirBlock(x, y, z - 1)) return true;
            else if (side == 3
                    && (TFCBlocks.isBlockVSupport(world.getBlock(x, y, z + 1))
                            || world.getBlock(x, y, z + 1).isOpaqueCube())
                    && world.isAirBlock(x, y, z + 1)) return true;
            else if (side == 4
                    && (TFCBlocks.isBlockVSupport(world.getBlock(x - 1, y, z))
                            || world.getBlock(x - 1, y, z).isOpaqueCube())
                    && world.isAirBlock(x - 1, y, z)) return true;
            else if (side == 5
                    && (TFCBlocks.isBlockVSupport(world.getBlock(x + 1, y, z))
                            || world.getBlock(x + 1, y, z).isOpaqueCube())
                    && world.isAirBlock(x + 1, y, z)) return true;
