...
public class BlockAnvil extends BlockTerraContainer {
    ...
    public boolean onBlockActivated(
            World world, int i, int j, int k, EntityPlayer entityplayer, int side, float hitX, float hitY, float hitZ) {
        if (world.isRemote) {
            return true;
        } else {
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World world, int x, int y, int z) {
        ...
        if (te.anvilTier != AnvilReq.STONE.Tier) {
            if (direction == 0) {
                ...
                return AxisAlignedBB.getBoundingBox(
                        x + 0.2, (double) y + 0, (double) z + 0, x + 0.8, y + 0.6, (double) z + 1);
            } else {
                this.setBlockBounds(0, 0, 0.2f, 1, 0.6f, 0.8f);
                return AxisAlignedBB.getBoundingBox(
                        (double) x + 0, (double) y + 0, z + 0.2, (double) x + 1, y + 0.6, z + 0.8);
            }
        } else {
            this.setBlockBounds(0, 0, 0, 1, 0.9F, 1);
            return AxisAlignedBB.getBoundingBox(
                    (double) x + 0, (double) y + 0, (double) z + 0, (double) x + 1, (double) y + 0.9F, (double) z + 1);
        }
    }
        ...
        if (var5 != null) {
            for (int var6 = 0; var6 < var5.getSizeInventory(); ++var6) {
                ...
                if (var7 != null) {
                    ...
                    for (float var10 = world.rand.nextFloat() * 0.8F + 0.1F;
                            var7.stackSize > 0;
    ...
    public void registerBlockIcons(IIconRegister registerer) {
        ...
        for (int i = (anvilId == 0 ? 1 : 0); i < (anvilId == 0 ? 8 : 3); i++) {
            textureMapTop[i] =
                    registerer.registerIcon(Reference.MOD_ID + ":" + "devices/Anvil_" + (i + anvilId) + "_Top");
            textureMapSide[i] =
                    registerer.registerIcon(Reference.MOD_ID + ":" + "devices/Anvil_" + (i + anvilId) + "_Side");
        }
