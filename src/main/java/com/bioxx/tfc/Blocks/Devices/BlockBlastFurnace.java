...
public class BlockBlastFurnace extends BlockTerraContainer {
            ...
            if (!canBlockStay(world, i, j, k)) {
                ...
                if (te.isValid) {
                    if (equippedItem != null
                            && (equippedItem.getItem() == TFCItems.fireStarter
    ...
    public boolean checkStackAt(World world, int x, int y, int z) {
        return checkBlock(world, x + 1, y, z, x, z)
                && checkBlock(world, x - 1, y, z, x, z)
    ...
    public boolean checkBlock(World world, int x, int y, int z, int stackX, int stackZ) {
        ...
        int xCoord = x - 1;
        int zCoord = z;
        if (world.blockExists(xCoord, y, zCoord)
                && !(xCoord == stackX && zCoord == stackZ)
    ...
    public void onBlockPlacedBy(
            World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack par6ItemStack) {
        if (!world.isRemote) {
