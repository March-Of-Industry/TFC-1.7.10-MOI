        ...
        if (!world.isRemote) {
            ...
            if (te.isLit()
                    || player.inventory.getCurrentItem() != null
                            && (player.inventory.getCurrentItem().getItem() == TFCItems.flintSteel
                                    || player.inventory.getCurrentItem().getItem() == TFCItems.fireStarter))
                return false;
            ...
            if (player.inventory.getCurrentItem() != null
                ...
                return true;
                    ...
                    && player.inventory.getCurrentItem().getItem() instanceof ItemLogs
                    && !player.isSneaking()
                    && te.straw == 8) {
                if (te.addLog(player.inventory.getCurrentItem(), player)) {
                    ...
                    return true;
                            ...
                            && !(player.inventory.getCurrentItem().getItem() instanceof ItemPotteryBase)
                ...
                if (te.wood > 0) {
                    ...
                    if (te.getStackInSlot(0) != null && te.getStackInSlot(0).getItem() instanceof ItemBlock
                            || hitX < 0.5 && hitZ < 0.5) te.ejectItem(0);
