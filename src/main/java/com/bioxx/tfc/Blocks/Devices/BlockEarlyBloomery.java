...
public class BlockEarlyBloomery extends BlockTerraContainer implements ICustomCollision {
    ...
    private boolean isNorthStackValid(World world, int x, int y, int z) {
        return (world.getBlock(x, y, z).getMaterial() == Material.rock
                ...
                || TFC_Core.isSouthFaceSolid(
                        world, x, y,
                        z); // Since its the North Block, we need to make sure the South side facing the stack is solid
    }
    ...
    private boolean isSouthStackValid(World world, int x, int y, int z) {
        return (world.getBlock(x, y, z).getMaterial() == Material.rock
                                || world.getBlock(x, y, z).getMaterial() == Material.iron)
                        && world.getBlock(x, y, z).isNormalCube()
                || TFC_Core.isNorthFaceSolid(
                        world, x, y,
                        z); // Since its the South Block, we need to make sure the North side facing the stack is solid
    }
    ...
    private boolean isEastStackValid(World world, int x, int y, int z) {
        return (world.getBlock(x, y, z).getMaterial() == Material.rock
                                || world.getBlock(x, y, z).getMaterial() == Material.iron)
                        && world.getBlock(x, y, z).isNormalCube()
                || TFC_Core.isWestFaceSolid(
                        world, x, y,
                        z); // Since its the East Block, we need to make sure the West side facing the stack is solid
    }
    ...
    private boolean isWestStackValid(World world, int x, int y, int z) {
        return (world.getBlock(x, y, z).getMaterial() == Material.rock
                ...
                || TFC_Core.isEastFaceSolid(
                        world, x, y,
                        z); // Since its the West Block, we need to make sure the East side facing the stack is solid
    }
