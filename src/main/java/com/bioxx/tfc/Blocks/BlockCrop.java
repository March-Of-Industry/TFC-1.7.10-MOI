...
public class BlockCrop extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister register) {
        ...
        for (int i = 1; i < 8; i++) {
            iconsPepperRed[i - 1] =
                    register.registerIcon(Reference.MOD_ID + ":" + "plants/crops/PepperRed (" + i + ")");
            iconsPepperYellow[i - 1] =
                    register.registerIcon(Reference.MOD_ID + ":" + "plants/crops/PepperYellow (" + i + ")");
            iconsGreenbean[i - 1] =
                    register.registerIcon(Reference.MOD_ID + ":" + "plants/crops/Greenbean (" + i + ")");
        ...
        for (int i = 1; i < 9; i++) {
            ...
            iconsSugarcane[i - 1] =
                    register.registerIcon(Reference.MOD_ID + ":" + "plants/crops/Sugarcane (" + i + ")");
        }
