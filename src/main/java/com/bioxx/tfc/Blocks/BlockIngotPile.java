...
public class BlockIngotPile extends BlockTerraContainer {
            ...
            if ((TEIngotPile) world.getTileEntity(x, y, z) != null) {
                ...
                if (!entityplayer.isSneaking() && tileentityingotpile.getStackInSlot(0) != null) {
                    ...
                    world.spawnEntityInWorld(new EntityItem(
                            ...
                            new ItemStack(
                                    tileentityingotpile.getStackInSlot(0).getItem(),
                                    1,
                                    tileentityingotpile.getStackInSlot(0).getItemDamage())));
    ...
    public void combineIngotsDown(World world, int x, int y, int z) {
        ...
        if (bottomSize < 64) {
            ...
            teipBottom.storage[0] =
                    new ItemStack(teipBottom.storage[0].getItem(), bottomSize, teipBottom.storage[0].getItemDamage());
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int x, int y, int z) {
        ...
        return AxisAlignedBB.getBoundingBox(
                x, (double) y + 0, (double) z + 0, (double) x + 1, y + 0.25, (double) z + 1);
    }
        ...
        if (te != null) {
            for (int var6 = 0; var6 < te.getSizeInventory(); ++var6) {
                ...
                if (var7 != null) {
                    ...
                    for (float var10 = this.random.nextFloat() * 0.8F + 0.1F;
                            var7.stackSize > 0;
