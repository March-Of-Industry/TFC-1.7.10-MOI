...
public class BlockMoss extends BlockTerra {
    ...
    private boolean canBePlacedOn(Block block) {
        ...
        else return block.renderAsNormalBlock() && block.getMaterial().blocksMovement();
    }
            ...
            for (int j1 = 0; j1 <= 3; ++j1) {
                ...
                if ((l & k1) != 0
                        ...
                        && (par1World.getBlock(par2, par3 + 1, par4) != this
                                || (par1World.getBlockMetadata(par2, par3 + 1, par4) & k1) == 0)) i1 &= ~k1;
            }
        }
            ...
            if (j1 == 1 && y < 255 && world.isAirBlock(x, y + 1, z)) {
                ...
                if (l1 > 0) {
                    for (i2 = 0; i2 <= 3; ++i2) {
                        if (!this.canBePlacedOn(
                                world.getBlock(x + Direction.offsetX[i2], y + 1, z + Direction.offsetZ[i2])))
                            l1 &= ~(1 << i2);
                    }
                ...
                if (j1 >= 2 && j1 <= 5 && (i1 & 1 << k1) == 0) {
                    ...
                    if (!block.isAir(world, x + Direction.offsetX[k1], y, z + Direction.offsetZ[k1])) {
                        ...
                        if ((i1 & 1 << i2) != 0
                                && this.canBePlacedOn(world.getBlock(
                            ...
                            world.setBlock(
                                ...
                                && world.isAirBlock(
                                        ...
                                        z + Direction.offsetZ[k1] + Direction.offsetZ[j2])
                                && this.canBePlacedOn(
                                        world.getBlock(x + Direction.offsetX[j2], y, z + Direction.offsetZ[j2])))
                            world.setBlock(
                                    x + Direction.offsetX[k1] + Direction.offsetX[j2],
                                    y,
                                    z + Direction.offsetZ[k1] + Direction.offsetZ[j2],
