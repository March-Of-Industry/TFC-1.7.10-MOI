...
public class BlockWaterPlant extends BlockSand implements ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister registerer) {
        seaWeed = registerer.registerIcon(
                seaweed); // registerer.registerIcon(Reference.ModID + ":" + "plants/Sea Grass");
        pondWeed = registerer.registerIcon(
                pondweed); // registerer.registerIcon(Reference.ModID + ":" + "plants/Pond Grass");
