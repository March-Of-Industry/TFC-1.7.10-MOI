...
public class BlockSlab extends BlockPartial {
    ...
    public float getBlockHardness(World world, int x, int y, int z) {
        TEPartial te = (TEPartial) world.getTileEntity(x, y, z);
        if (te != null) return Block.getBlockById(te.typeID).getBlockHardness(world, x, y, z);
    ...
    public boolean isSideSolid(IBlockAccess world, int x, int y, int z, ForgeDirection side) {
        ...
        switch (side) {
            case DOWN /*DOWN*/:
                return getBottomChiselLevel(data) == 0
                        && getNorthChiselLevel(data) == 0
                        && getSouthChiselLevel(data) == 0
                        && getEastChiselLevel(data) == 0
                        && getWestChiselLevel(data) == 0;
            case UP /*UP*/:
                return getTopChiselLevel(data) == 0
                        && getNorthChiselLevel(data) == 0
                        && getSouthChiselLevel(data) == 0
                        && getEastChiselLevel(data) == 0
                        && getWestChiselLevel(data) == 0;
            case NORTH /*NORTH*/:
                return getNorthChiselLevel(data) == 0
                        && getEastChiselLevel(data) == 0
                        && getWestChiselLevel(data) == 0
                        && getTopChiselLevel(data) == 0
                        && getBottomChiselLevel(data) == 0;
            case SOUTH /*SOUTH*/:
                return getSouthChiselLevel(data) == 0
                        && getEastChiselLevel(data) == 0
                        && getWestChiselLevel(data) == 0
                        && getTopChiselLevel(data) == 0
                        && getBottomChiselLevel(data) == 0;
            case EAST /*EAST*/:
                return getEastChiselLevel(data) == 0
                        && getNorthChiselLevel(data) == 0
                        && getSouthChiselLevel(data) == 0
                        && getTopChiselLevel(data) == 0
                        && getBottomChiselLevel(data) == 0;
            case WEST /*WEST*/:
                return getWestChiselLevel(data) == 0
                        && getNorthChiselLevel(data) == 0
                        && getSouthChiselLevel(data) == 0
                        && getTopChiselLevel(data) == 0
                        && getBottomChiselLevel(data) == 0;
