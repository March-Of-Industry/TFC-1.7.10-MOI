...
public class WMobs implements IWailaEntityProvider {
    ...
    public List<String> getWailaHead(
            Entity entity, List<String> currenttip, IWailaEntityAccessor accessor, IWailaConfigHandler config) {
    ...
    public List<String> getWailaBody(
        ...
        if (pregnant) {
            currenttip.add(TFC_Core.translate("entity.pregnant") + " : "
        ...
        if (config.getConfig("tfc.familiarToday") && animal.canFamiliarize()) {
            if (familiarizedToday)
                currenttip.add(
                        TFC_Core.translate("gui.familiarized") + EnumChatFormatting.GREEN.toString() + " \u2714");
