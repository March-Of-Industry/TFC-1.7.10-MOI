...
public class TFCItems {
    ...
    public static void registerItems() {
        ...
        GameRegistry.registerItem(
                bismuthBronzeUnfinishedChestplate, bismuthBronzeUnfinishedChestplate.getUnlocalizedName());
        GameRegistry.registerItem(
                blackBronzeUnfinishedChestplate, blackBronzeUnfinishedChestplate.getUnlocalizedName());
        ...
        GameRegistry.registerItem(
                wroughtIronUnfinishedChestplate, wroughtIronUnfinishedChestplate.getUnlocalizedName());
