...
public class TFC_ItemHeat {
    ...
    public static boolean hasTemp(ItemStack is) {
        if (is != null) {
            if (is.hasTagCompound() && is.getTagCompound().hasKey("temperature")) return true;
        }
        return false;
    }
    ...
    public static Boolean setTemp(ItemStack is, float temp) {
        if (is != null) {
            if (is.hasTagCompound()) is.getTagCompound().setFloat("temperature", temp);
    ...
    public static void removeTempTag(ItemStack is) {
        ...
        if (is.hasTagCompound() && is.getTagCompound().hasNoTags()) is.stackTagCompound = null;
    }
}
