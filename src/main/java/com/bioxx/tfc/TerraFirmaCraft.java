...
public class TerraFirmaCraft {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        GameRegistry.registerWorldGenerator(
                new WorldGenFissure(TFCBlocks.lava, 2, true, TFCOptions.lavaFissureRarity)
                        .setUnderground(true, 20)
                        .setSeed(1),
                0);
        GameRegistry.registerWorldGenerator(
                new WorldGenFissure(TFCBlocks.freshWaterStationary, 2, false, TFCOptions.waterFissureRarity), 0);
        // Surface Hotsprings
