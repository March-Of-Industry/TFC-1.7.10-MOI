...
public class BlockSetup extends TFCBlocks {
    ...
    public static void loadBlocks() {
        ...
        bookshelf = new BlockCustomBookshelf()
                .setHardness(1.5F)
        ...
        torchOff = new BlockTorchOff()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("TorchOff")
                .setBlockTextureName("torch_on");
        chest = new BlockChestTFC()
                .setHardness(2.5F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("Chest");
        ...
        cactus = new BlockCustomCactus()
                .setHardness(0.4F)
                .setStepSound(Block.soundTypeCloth)
                .setBlockName("Cactus")
                .setBlockTextureName("cactus");
        reeds = new BlockCustomReed()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("Reeds")
                .setBlockTextureName("reeds");
        pumpkin = new BlockCustomPumpkin(false)
                .setHardness(1.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("Pumpkin")
                .setBlockTextureName("pumpkin");
        litPumpkin = new BlockCustomPumpkin(true)
                .setHardness(1.0F)
                .setStepSound(Block.soundTypeWood)
                .setLightLevel(1.0F)
                .setBlockName("LitPumpkin")
                .setBlockTextureName("pumpkin");
        buttonWood = new BlockCustomButtonWood()
                .setHardness(0.5F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("ButtonWood");
        vine = new BlockCustomVine()
                .setHardness(0.2F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("Vine")
        ...
        dirt = new BlockDirt(0)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("dirt");

        dirt2 = new BlockDirt(16)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("dirt");
        clay = new BlockClay(0)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("clay");
        clay2 = new BlockClay(16)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("clay");
        clayGrass = new BlockClayGrass(0)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("ClayGrass");
        clayGrass2 = new BlockClayGrass(16)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("ClayGrass");
        ...
        peat = new BlockPeat()
                ...
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("Peat");
        peatGrass = new BlockPeatGrass()
                .setHardness(3F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("PeatGrass");
        dryGrass = new BlockDryGrass(0)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("DryGrass");
        dryGrass2 = new BlockDryGrass(16)
                .setHardness(3F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("DryGrass");
        tallGrass = new BlockCustomTallGrass()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("TallGrass");
        sand = new BlockSand(0)
                .setHardness(0.5F)
                .setStepSound(Block.soundTypeSand)
                .setBlockName("sand");
        sand2 = new BlockSand(16)
                .setHardness(0.5F)
                .setStepSound(Block.soundTypeSand)
                .setBlockName("sand");
        ...
        sulfur = new BlockSulfur(Material.rock)
                .setBlockName("Sulfur")
                .setHardness(0.5F)
                .setResistance(1F);

        logPile = new BlockLogPile().setHardness(10F).setResistance(1F).setBlockName("LogPile");
        woodSupportV = new BlockWoodSupport(Material.wood)
                .setBlockName("WoodSupportV")
                .setHardness(0.5F)
                .setResistance(1F);
        woodSupportH = new BlockWoodSupport(Material.wood)
                .setBlockName("WoodSupportH")
                .setHardness(0.5F)
                .setResistance(1F);
        woodSupportV2 = new BlockWoodSupport2(Material.wood)
                .setBlockName("WoodSupportV2")
                .setHardness(0.5F)
                .setResistance(1F);
        woodSupportH2 = new BlockWoodSupport2(Material.wood)
                .setBlockName("WoodSupportH2")
                .setHardness(0.5F)
                .setResistance(1F);

        tilledSoil = new BlockFarmland(TFCBlocks.dirt, 0)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("tilledSoil");
        tilledSoil2 = new BlockFarmland(TFCBlocks.dirt2, 16)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("tilledSoil");

        fruitTreeWood = new BlockFruitWood()
                .setBlockName("fruitTreeWood")
                .setHardness(5.5F)
                .setResistance(2F);
        fruitTreeLeaves = new BlockFruitLeaves(0)
                .setBlockName("fruitTreeLeaves")
                .setHardness(0.5F)
                .setResistance(1F)
                .setStepSound(Block.soundTypeGrass);
        fruitTreeLeaves2 = new BlockFruitLeaves(8)
                .setBlockName("fruitTreeLeaves2")
                .setHardness(0.5F)
                .setResistance(1F)
                .setStepSound(Block.soundTypeGrass);

        woodConstruct = new BlockWoodConstruct()
                .setHardness(4F)
                .setStepSound(Block.soundTypeWood)
        ...
        blastFurnace = new BlockBlastFurnace()
                ...
                .setHardness(20)
                .setLightLevel(0F);
        bloomery = new BlockEarlyBloomery()
                .setBlockName("EarlyBloomery")
                .setHardness(20)
                .setLightLevel(0F);
        ...
        planks = new BlockPlanks(Material.wood)
                .setHardness(4.0F)
                .setResistance(5.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("wood");
        planks2 = new BlockPlanks2(Material.wood)
                .setHardness(4.0F)
                .setResistance(5.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("wood2");
        leaves = new BlockCustomLeaves()
                .setHardness(0.2F)
                .setLightOpacity(1)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("leaves")
                .setCreativeTab(TFCTabs.TFC_DECORATION);
        leaves2 = new BlockCustomLeaves2()
                .setHardness(0.2F)
                .setLightOpacity(1)
                .setStepSound(Block.soundTypeGrass)
        ...
        sapling2 = new BlockSapling2()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("sapling2");

        logNatural = new BlockLogNatural()
                .setHardness(50.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("log");
        logNatural2 = new BlockLogNatural2()
                .setHardness(50.0F)
                .setStepSound(Block.soundTypeWood)
                .setBlockName("log2");
        woodVert = new BlockLogVert()
                .setBlockName("WoodVert")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        woodVert2 = new BlockLogVert2()
                .setBlockName("WoodVert2")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        woodHoriz = new BlockLogHoriz(0)
                .setBlockName("WoodHoriz")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        woodHoriz2 = new BlockLogHoriz(8)
                .setBlockName("WoodHoriz2")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        woodHoriz3 = new BlockLogHoriz2(0)
                .setBlockName("WoodHoriz3")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        // Use 8 instead of 0 if Global.WOOD_ALL.length > 24
        woodHoriz4 = new BlockLogHoriz2(/*8*/ 0)
                .setBlockName("WoodHoriz4")
                .setHardness(20)
                .setResistance(15F)
                .setStepSound(Block.soundTypeWood);
        ...
        fence = new BlockTFCFence("Fence", Material.wood)
                .setBlockName("FenceTFC")
                .setHardness(2);
        fenceGate = new BlockCustomFenceGate().setBlockName("FenceGateTFC").setHardness(2);
        fence2 = new BlockTFCFence2("Fence2", Material.wood)
                .setBlockName("FenceTFC")
                .setHardness(2);
        fenceGate2 = new BlockCustomFenceGate2().setBlockName("FenceGateTFC").setHardness(2);
        strawHideBed =
                new BlockBed().setBlockName("StrawHideBed").setHardness(1).setCreativeTab(null);
        ...
        berryBush =
                new BlockBerryBush().setBlockName("BerryBush").setHardness(0.3f).setStepSound(Block.soundTypeGrass);
        crops = new BlockCrop().setBlockName("crops").setHardness(0.3F).setStepSound(Block.soundTypeGrass);
        lilyPad = new BlockCustomLilyPad()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("LilyPad")
                .setBlockTextureName("waterlily");
        flowers = new BlockFlower()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("Flowers");
        flowers2 = new BlockFlower2()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("Flowers2");
        fungi = new BlockFungi()
                .setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass)
                .setBlockName("Fungi");

        saltWater = new BlockSaltWater(TFCFluids.SALTWATER)
                .setHardness(100.0F)
                .setLightOpacity(3)
                .setBlockName("SaltWater");
        saltWaterStationary = new BlockLiquidStatic(TFCFluids.SALTWATER, Material.water, saltWater)
                .setHardness(100.0F)
                .setLightOpacity(3)
                .setBlockName("SaltWaterStationary");

        freshWater = new BlockFreshWater(TFCFluids.FRESHWATER)
                .setHardness(100.0F)
                .setLightOpacity(3)
        ...
        hotWater = new BlockHotWater(TFCFluids.HOTWATER)
                .setHardness(100.0F)
                .setLightOpacity(3)
                .setBlockName("HotWater");
        hotWaterStationary = new BlockHotWaterStatic(TFCFluids.HOTWATER, Material.water, hotWater)
                .setHardness(100.0F)
                .setLightOpacity(3)
        ...
        lava = new BlockLava()
                ...
                .setLightOpacity(255)
                .setBlockName("Lava");
        lavaStationary = new BlockLiquidStatic(TFCFluids.LAVA, Material.lava, lava)
                .setHardness(0.0F)
                .setLightLevel(1.0F)
                .setLightOpacity(255)
                .setBlockName("LavaStationary");
        ice = new BlockCustomIce()
                .setHardness(0.5F)
                .setLightOpacity(3)
        ...
        waterPlant = new BlockWaterPlant(0)
                .setBlockName("SeaGrassStill")
                .setHardness(0.5f)
                .setStepSound(Block.soundTypeGravel);
        ...
        gravel = new BlockGravel(0)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("gravel");
        gravel2 = new BlockGravel(16)
                .setHardness(2F)
                .setStepSound(Block.soundTypeGravel)
                .setBlockName("gravel");
